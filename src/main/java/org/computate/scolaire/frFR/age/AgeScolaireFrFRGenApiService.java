...
/**
 * Traduire: false
 * classeNomCanonique.enUS: org.computate.scolaire.enUS.age.SchoolAgeEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface AgeScolaireFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("frFRAgeScolaire").register(AgeScolaireFrFRGenApiService.class, new AgeScolaireFrFRApiServiceImpl(siteContexte));
	}
