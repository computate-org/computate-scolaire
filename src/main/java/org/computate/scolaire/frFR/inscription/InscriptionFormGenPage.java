...
public class InscriptionFormGenPage extends InscriptionFormGenPageGen<ClusterPage> {
	...
	@Override public void htmlBodyInscriptionFormGenPage() {
		...
		if(listeInscriptionScolaire == null || listeInscriptionScolaire.size() == 0) {
			...
			{ e("h1").f();
				{ e("a").a("href", "/inscription-form").a("class", "w3-bar-item w3-btn w3-center w3-block w3-blue-gray w3-hover-blue-gray ").f();
			...
			e("div").a("class", "").f();
				{ e("div").f();
					...
					if(start1 == 0) {
						...
						{ e("a").a("href", "/inscription-form?q=", query, fqs, sorts, "&start=", start2, "&rows=", rows1).f();
					...
					if(rows1 <= 1) {
						...
						{ e("a").a("href", "/inscription-form?q=", query, fqs, sorts, "&start=", start1, "&rows=", rows2).f();
							e("i").a("class", "fas fa-minus-square ").f().g("i");
						} g("a");
					}

					{ e("a").a("href", "/inscription-form?q=", query, fqs, sorts, "&start=", start1, "&rows=", rows3).f();
					...
					if(start3 >= num) {
						...
						{ e("a").a("href", "/inscription-form?q=", query, fqs, sorts, "&start=", start3, "&rows=", rows1).f();
							e("i").a("class", "fas fa-arrow-square-right ").f().g("i");
						} g("a");
					}
						e("span").f().sx((start1 + 1), " - ", (start1 + rows1), " de ", num).g("span");
				} g("div");
				table1InscriptionFormGenPage();
		}
	...
	public void table1InscriptionFormGenPage() {
		{ e("table").a("class", "w3-table w3-bordered w3-striped w3-border w3-hoverable ").f();
			table2InscriptionFormGenPage();
		} g("table");
	}

	public void table2InscriptionFormGenPage() {
		thead1InscriptionFormGenPage();
		tbody1InscriptionFormGenPage();
		tfoot1InscriptionFormGenPage();
	}

	public void thead1InscriptionFormGenPage() {
		{ e("thead").a("class", "w3-blue-gray w3-hover-blue-gray ").f();
			thead2InscriptionFormGenPage();
		} g("thead");
	}

	public void thead2InscriptionFormGenPage() {
			{ e("tr").f();
			if(getColonneCree()) {
				e("th").f().sx("crée").g("th");
			}
	...
	public void tbody1InscriptionFormGenPage() {
		{ e("tbody").f();
			tbody2InscriptionFormGenPage();
		} g("tbody");
	}

	public void tbody2InscriptionFormGenPage() {
	...
	public void tfoot1InscriptionFormGenPage() {
		{ e("tfoot").a("class", "w3-blue-gray w3-hover-blue-gray ").f();
			tfoot2InscriptionFormGenPage();
		} g("tfoot");
	}

	public void tfoot2InscriptionFormGenPage() {
		{ e("tr").f();
	...
	public void htmlBodyFormsInscriptionFormGenPage() {
		...
		htmlSuggereInscriptionFormGenPage(this, null, listeInscriptionScolaire);
	}

	/**
	**/
	public static void htmlSuggereInscriptionFormGenPage(MiseEnPage p, String id, ListeRecherche<InscriptionScolaire> listeInscriptionScolaire) {
		...
		try {
			...
			if(
					CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRessource(), InscriptionFormGenPage.ROLES)
					|| CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRoyaume(), InscriptionFormGenPage.ROLES)
					) {
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "rechargerToutesInscriptionFormGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue-gray ").a("onclick", "patchInscriptionScolaireVals([], {}, function() { ajouterLueur($('#rechargerToutesInscriptionFormGenPage", id, "')); }, function() { ajouterErreur($('#rechargerToutesInscriptionFormGenPage", id, "')); }); ").f();
			...
			{ p.e("div").a("class", "w3-bar ").f();
				...
				p.e("input")
					...
					.a("onkeyup", "if (event.keyCode === 13) { event.preventDefault(); window.location.href = '/inscription-form?q=", query1, ":' + encodeURIComponent(this.value) + '", fqs, sorts, "&start=", start2, "&rows=", rows1, "'; }"); 
				...
				{ p.e("button")
					...
					.a("onclick", "window.location.href = '/inscription-form?q=", query1, ":' + encodeURIComponent(this.previousElementSibling.value) + '", fqs, sorts, "&start=", start2, "&rows=", rows1, "'; ") 
					.f();
