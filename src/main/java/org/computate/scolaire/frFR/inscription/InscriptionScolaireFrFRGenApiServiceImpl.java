...
public class InscriptionScolaireFrFRGenApiServiceImpl implements InscriptionScolaireFrFRGenApiService {
	...
	public void pagerechercheInscriptionScolairePageInit(InscriptionPage page, ListeRecherche<InscriptionScolaire> listeInscriptionScolaire) {
	}
	...
	public void reponse200PageRechercheInscriptionScolaire(ListeRecherche<InscriptionScolaire> listeInscriptionScolaire, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			...
			pagerechercheInscriptionScolairePageInit(page, listeInscriptionScolaire);
	...
	public void rechargerpagerechercheInscriptionScolairePageInit(PageInscription page, ListeRecherche<InscriptionScolaire> listeInscriptionScolaire) {
	}
	...
	public void reponse200RechargerPageRechercheInscriptionScolaire(ListeRecherche<InscriptionScolaire> listeInscriptionScolaire, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		try {
			...
			page.setListeInscriptionScolaire(listeInscriptionScolaire);
			page.setRequeteSite_(requeteSite);
			rechargerpagerechercheInscriptionScolairePageInit(page, listeInscriptionScolaire);
		...
		try {
			...
			-> {
				if(creerAsync.succeeded()) {
					...
					LOGGER.error(String.format("creerInscriptionScolaire a échoué. ", creerAsync.cause()));
	...
	public void rechercheInscriptionScolaireFq(String uri, String apiMethode, ListeRecherche<InscriptionScolaire> listeRecherche, String entiteVar, String valeurIndexe, String varIndexe) {
		...
		if(StringUtils.startsWith(valeurIndexe, "[")) {
			...
			String fq1 = fqs[0].equals("*") ? fqs[0] : InscriptionScolaire.staticSolrFqPourClasse(entiteVar, listeRecherche.getRequeteSite_(), fqs[0]);
			String fq2 = fqs[1].equals("*") ? fqs[1] : InscriptionScolaire.staticSolrFqPourClasse(entiteVar, listeRecherche.getRequeteSite_(), fqs[1]);
			listeRecherche.addFilterQuery(varIndexe + ":[" + fq1 + " TO " + fq2 + "]");
		} else {
			listeRecherche.addFilterQuery(varIndexe + ":" + InscriptionScolaire.staticSolrFqPourClasse(entiteVar, listeRecherche.getRequeteSite_(), valeurIndexe));
		}
	}
