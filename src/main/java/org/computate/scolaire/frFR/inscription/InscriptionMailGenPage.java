		...
		{ p.e("div").a("class", "w3-cell-row w3-padding ").f();
			{ p.e("div").a("class", "w3-cell ").f();
				{ p.e("div").a("class", "w3-cell-row ").f();
					...
					{ p.e("form").a("action", "").a("id", "suggereFormInscriptionScolaire", id).a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); window.location.href='/inscription/mail?q=objetSuggere:' + encodeURIComponent($('#suggereInscriptionScolaire", id, "').val()); return false; ").f();
						p.e("input")
							.a("type", "text")
