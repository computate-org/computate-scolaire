 ...
 * Traduire: false
 **/
public class InscriptionMailGenPage extends InscriptionMailGenPageGen<ClusterPage> {
	...
	@Override protected void _pageUri(Couverture<String> c) {
		c.o("/inscription-mail");
	}

	@Override protected void _pageImageUri(Couverture<String> c) {
			c.o("/png/inscription-mail-999.png");
	}
	...
	@Override public void initLoinInscriptionMailGenPage() {
		initInscriptionMailGenPage();
		super.initLoinMiseEnPage();
	}

	@Override public void htmlScriptsInscriptionMailGenPage() {
		e("script").a("src", statiqueUrlBase, "/js/frFR/InscriptionMailPage.js").f().g("script");
	...
	@Override public void htmlScriptInscriptionMailGenPage() {
	...
	@Override public void htmlBodyInscriptionMailGenPage() {
			...
			e("div").a("class", "").f();
				{ e("div").f();
					...
					if(start1 == 0) {
						...
						{ e("a").a("href", "/inscription-mail?q=", query, fqs, sorts, "&start=", start2, "&rows=", rows1).f();
					...
					if(rows1 <= 1) {
						...
						{ e("a").a("href", "/inscription-mail?q=", query, fqs, sorts, "&start=", start1, "&rows=", rows2).f();
							e("i").a("class", "fas fa-minus-square ").f().g("i");
						} g("a");
					}

					{ e("a").a("href", "/inscription-mail?q=", query, fqs, sorts, "&start=", start1, "&rows=", rows3).f();
					...
					if(start3 >= num) {
						...
						{ e("a").a("href", "/inscription-mail?q=", query, fqs, sorts, "&start=", start3, "&rows=", rows1).f();
							e("i").a("class", "fas fa-arrow-square-right ").f().g("i");
						} g("a");
					}
						e("span").f().sx((start1 + 1), " - ", (start1 + rows1), " de ", num).g("span");
				} g("div");
				table1InscriptionMailGenPage();
		}
		...
		htmlBodyFormsInscriptionMailGenPage();
		g("div");
	}

	public void table1InscriptionMailGenPage() {
		{ e("table").a("class", "w3-table w3-bordered w3-striped w3-border w3-hoverable ").f();
			table2InscriptionMailGenPage();
		} g("table");
	}

	public void table2InscriptionMailGenPage() {
		thead1InscriptionMailGenPage();
		tbody1InscriptionMailGenPage();
		tfoot1InscriptionMailGenPage();
	}
	...
	public void thead2InscriptionMailGenPage() {
			{ e("tr").f();
			if(getColonneCree()) {
				e("th").f().sx("crée").g("th");
			}
	...
	public void tbody1InscriptionMailGenPage() {
		{ e("tbody").f();
			tbody2InscriptionMailGenPage();
		} g("tbody");
	}

	public void tbody2InscriptionMailGenPage() {
		...
		for(int i = 0; i < listeInscriptionScolaire.size(); i++) {
			...
			String uri = "/inscription-mail/" + o.getPk();
			{ e("tr").f();
				if(getColonneCree()) {
					{ e("td").f();
						{ e("a").a("href", uri).f();
	...
	public void tfoot2InscriptionMailGenPage() {
		{ e("tr").f();
	...
	public void htmlBodyFormsInscriptionMailGenPage() {
		if(
				CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRessource(), ROLES)
				|| CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRoyaume(), ROLES)
				) {
		...
		htmlSuggereInscriptionMailGenPage(this, null, listeInscriptionScolaire);
	}

	/**
	**/
	public static void htmlSuggereInscriptionMailGenPage(MiseEnPage p, String id, ListeRecherche<InscriptionScolaire> listeInscriptionScolaire) {
		...
		try {
			...
			if(
					CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRessource(), InscriptionMailGenPage.ROLES)
			...
			{ p.e("div").a("class", "w3-bar ").f();
				...
				p.e("input")
					...
					.a("onkeyup", "if (event.keyCode === 13) { event.preventDefault(); window.location.href = '/inscription-mail?q=", query1, ":' + encodeURIComponent(this.value) + '", fqs, sorts, "&start=", start2, "&rows=", rows1, "'; }"); 
				if(listeInscriptionScolaire != null)
					p.a("value", query2);
				p.fg();
				{ p.e("button")
					.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-bar-item w3-blue-gray ")
					.a("onclick", "window.location.href = '/inscription-mail?q=", query1, ":' + encodeURIComponent(this.previousElementSibling.value) + '", fqs, sorts, "&start=", start2, "&rows=", rows1, "'; ") 
					.f();
