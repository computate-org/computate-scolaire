...
public interface DesignInscriptionFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("frFRDesignInscription").register(DesignInscriptionFrFRGenApiService.class, new DesignInscriptionFrFRApiServiceImpl(siteContexte));
	}
