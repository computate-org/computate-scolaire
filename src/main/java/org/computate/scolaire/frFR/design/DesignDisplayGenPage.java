...
public class DesignDisplayGenPage extends DesignDisplayGenPageGen<ClusterPage> {
	...
	@Override public void initLoinDesignDisplayGenPage() {
		initDesignDisplayGenPage();
		super.initLoinMiseEnPage();
	}

	@Override public void htmlScriptsDesignDisplayGenPage() {
		e("script").a("src", statiqueUrlBase, "/js/frFR/DesignDisplayPage.js").f().g("script");
	...
	public void htmlBodyFormsDesignDisplayGenPage() {
			...
			if(listeDesignPage != null && listeDesignPage.size() == 1) {
				{ e("button")
					.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-khaki ")
						.a("id", "rechargerCeDesignDisplayGenPage")
						.a("onclick", "patchDesignPageVals( [ {name: 'fq', value: 'pk:' + " + requeteSite_.getRequetePk() + " } ], {}, function() { ajouterLueur($('#rechargerCeDesignDisplayGenPage')); }, function() { ajouterErreur($('#rechargerCeDesignDisplayGenPage')); }); return false; ").f();
		...
		htmlSuggereDesignDisplayGenPage(this, null, listeDesignPage);
	}

	/**
	**/
	public static void htmlSuggereDesignDisplayGenPage(MiseEnPage p, String id, ListeRecherche<DesignPage> listeDesignPage) {
		...
		try {
			...
			if(
					CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRessource(), DesignDisplayGenPage.ROLES)
					|| CollectionUtils.containsAny(requeteSite_.getUtilisateurRolesRoyaume(), DesignDisplayGenPage.ROLES)
					) {
					{ p.e("div").a("class", "").f();
						{ p.e("button").a("id", "rechargerTousDesignDisplayGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-khaki ").a("onclick", "patchDesignPageVals([], {}, function() { ajouterLueur($('#rechargerTousDesignDisplayGenPage", id, "')); }, function() { ajouterErreur($('#rechargerTousDesignDisplayGenPage", id, "')); }); ").f();
