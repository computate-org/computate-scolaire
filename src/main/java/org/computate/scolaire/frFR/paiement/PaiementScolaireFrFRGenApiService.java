...
/**
 * Traduire: false
 * classeNomCanonique.enUS: org.computate.scolaire.enUS.payment.SchoolPaymentEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface PaiementScolaireFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("frFRPaiementScolaire").register(PaiementScolaireFrFRGenApiService.class, new PaiementScolaireFrFRApiServiceImpl(siteContexte));
	}
