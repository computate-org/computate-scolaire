...
/**
 * Traduire: false
 * NomCanonique.enUS: org.computate.scolaire.enUS.session.SchoolSessionEnUSGenApiService
 * Gen: false
 **/
@WebApiServiceGen
@ProxyGen
public interface SessionScolaireFrFRGenApiService {
	static void enregistrerService(SiteContexteFrFR siteContexte, Vertx vertx) {
		new ServiceBinder(vertx).setAddress("computate-scolaire-frFR-SessionScolaire").register(SessionScolaireFrFRGenApiService.class, new SessionScolaireFrFRApiServiceImpl(siteContexte));
	}
