...
public class SessionScolaireFrFRGenApiServiceImpl implements SessionScolaireFrFRGenApiService {
	...
	public void postSessionScolaire(JsonObject body, OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		...
		requeteSite.setRequeteUri("/api/session");
								...
								if(l2 != null) {
									futures.add(Future.future(a -> {
										tx.preparedQuery(SiteContexteFrFR.SQL_addA)
												.execute(Tuple.of(pk, "ageCles", l2, "sessionCle")
												, b
										-> {
											if(b.succeeded())
												a.handle(Future.succeededFuture());
					...
					case "saisonCle":
						{
							...
							if(l != null) {
								...
								if(l2 != null) {
									futures.add(Future.future(a -> {
										tx.preparedQuery(SiteContexteFrFR.SQL_addA)
												.execute(Tuple.of(pk, "saisonCle", l2, "sessionCles")
												, b
										-> {
											if(b.succeeded())
												a.handle(Future.succeededFuture());
	...
	public void putimportSessionScolaire(JsonObject body, OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourSessionScolaire(siteContexte, operationRequete, body);
		requeteSite.setRequeteUri("/api/session/import");
	...
	public void putfusionSessionScolaire(JsonObject body, OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourSessionScolaire(siteContexte, operationRequete, body);
		requeteSite.setRequeteUri("/api/session/fusion");
	...
	public void putcopieSessionScolaire(JsonObject body, OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourSessionScolaire(siteContexte, operationRequete, body);
		requeteSite.setRequeteUri("/api/session/copie");
				...
				for(Integer i = 0; i < entiteVars.size(); i++) {
					...
					case "ageCles":
						for(Long l : Optional.ofNullable(jsonObject.getJsonArray(entiteVar)).orElse(new JsonArray()).stream().map(a -> Long.parseLong((String)a)).collect(Collectors.toList())) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContexteFrFR.SQL_addA)
										.execute(Tuple.of(pk, "ageCles", l, "sessionCle")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "saisonCle":
						...
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContexteFrFR.SQL_addA)
									.execute(Tuple.of(pk, "saisonCle", l, "sessionCles")
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
										...
										try {
											rechercheSessionScolaire(requeteSite, false, true, true, "/api/session", "PATCH", d -> {
												if(d.succeeded()) {
													...
													if(listeSessionScolaire.getQueryResponse().getResults().getNumFound() > 1
														...
														erreurSessionScolaire(requeteSite, gestionnaireEvenements, Future.failedFuture(message));
													} else {
	...
	public void getSessionScolaire(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		...
		requeteSite.setRequeteUri("/api/session/{id}");
	...
	public void pagerechercheSessionScolaire(OperationRequest operationRequete, Handler<AsyncResult<OperationResponse>> gestionnaireEvenements) {
		RequeteSiteFrFR requeteSite = genererRequeteSiteFrFRPourSessionScolaire(siteContexte, operationRequete);
		requeteSite.setRequeteUri("/session");
	...
	public void creerSessionScolaire(RequeteSiteFrFR requeteSite, Handler<AsyncResult<SessionScolaire>> gestionnaireEvenements) {
		try {
			...
			tx.preparedQuery(SiteContexteFrFR.SQL_creer)
					...
					.execute(Tuple.of(SessionScolaire.class.getCanonicalName(), utilisateurId, cree.toOffsetDateTime())
					, creerAsync
			-> {
	...
	public void rechercheSessionScolaireFq(String uri, String apiMethode, ListeRecherche<SessionScolaire> listeRecherche, String entiteVar, String valeurIndexe, String varIndexe) {
		...
		if(StringUtils.startsWith(valeurIndexe, "[")) {
			...
			String fq1 = fqs[0].equals("*") ? fqs[0] : SessionScolaire.staticSolrFqPourClasse(entiteVar, listeRecherche.getRequeteSite_(), fqs[0]);
			String fq2 = fqs[1].equals("*") ? fqs[1] : SessionScolaire.staticSolrFqPourClasse(entiteVar, listeRecherche.getRequeteSite_(), fqs[1]);
			listeRecherche.addFilterQuery(varIndexe + ":[" + fq1 + " TO " + fq2 + "]");
		} else {
			listeRecherche.addFilterQuery(varIndexe + ":" + SessionScolaire.staticSolrFqPourClasse(entiteVar, listeRecherche.getRequeteSite_(), valeurIndexe));
		}
	}
	...
	public void rechercheSessionScolaire(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, Boolean modifier, String uri, String apiMethode, Handler<AsyncResult<ListeRecherche<SessionScolaire>>> gestionnaireEvenements) {
		try {
			ListeRecherche<SessionScolaire> listeRecherche = rechercheSessionScolaireListe(requeteSite, peupler, stocker, modifier, uri, apiMethode);
	...
	public ListeRecherche<SessionScolaire> rechercheSessionScolaireListe(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, Boolean modifier, String uri, String apiMethode) {
		OperationRequest operationRequete = requeteSite.getOperationRequete();
		...
		rechercheSessionScolaire2(requeteSite, peupler, stocker, modifier, uri, apiMethode, listeRecherche);
		listeRecherche.initLoinPourClasse(requeteSite);
		return listeRecherche;
	}
	public void rechercheSessionScolaire2(RequeteSiteFrFR requeteSite, Boolean peupler, Boolean stocker, Boolean modifier, String uri, String apiMethode, ListeRecherche<SessionScolaire> listeRecherche) {
	}
