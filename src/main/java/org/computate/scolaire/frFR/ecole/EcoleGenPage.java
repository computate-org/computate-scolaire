...
public class EcoleGenPage extends EcoleGenPageGen<ClusterPage> {
	...
	@Override public void htmlScriptEcoleGenPage() {
		...
		tl(1, "suggereEcoleAnneeCles($('#formEcoleAnneeCles'), $('#listEcoleAnneeCles')); ");
		l("});");
	}
	...
	public void htmlFormPageEcole(Ecole o) {
		...
		{ e("div").a("class", "w3-cell-row ").f();
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formEcoleEcoleEmplacement").a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
								...
								{ e("div").a("class", "w3-cell ").f();
									...
									e("i").a("class", "far fa-search w3-xxlarge w3-cell w3-cell-middle ").f().g("i");
										e("input")
											...
											.a("id", "Page_anneeCles")
											.a("autocomplete", "off")
											.a("oninput", "suggereEcoleAnneeCles($('#' + ($(this).val() ? 'suggere' : 'form') + 'EcoleAnneeCles'), $('#listEcoleAnneeCles')); ")
										.fg();
