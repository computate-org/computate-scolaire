	...
	@Override public void htmlBodyBlocGenPage() {
		...
		if(listeBlocScolaire == null || listeBlocScolaire.size() == 0) {
			...
			if(pageH1 != null) {
				{ e("h1").f();
					if(contexteIconeClassesCss != null)
						e("i").a("class", contexteIconeClassesCss + " site-menu-icon ").f().g("i");
					e("span").a("class", " ").f().sx("un bloc").g("span");
				} g("h1");
		...
		if(listeBlocScolaire != null && listeBlocScolaire.size() == 1 && params.getJsonObject("query").getString("q").equals("*:*")) {
			...
			{ e("div").a("class", "").f();
				...
				if(o.getPk() != null) {
					{ e("form").a("action", "").a("id", "BlocScolaireForm").a("style", "display: inline-block; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
						.a("name", "pk")
						.a("class", "valeurPk")
						.a("type", "hidden")
