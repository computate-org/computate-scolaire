...
public class BlocGenPage extends BlocGenPageGen<ClusterPage> {
	...
	@Override public void htmlScriptBlocGenPage() {
		...
		tl(1, "suggereBlocScolaireAgeCle($('#formBlocScolaireAgeCle'), $('#listBlocScolaireAgeCle')); ");
		tl(1, "suggereBlocScolaireInscriptionCles($('#formBlocScolaireInscriptionCles'), $('#listBlocScolaireInscriptionCles')); ");
		l("});");
	}
	...
	public void htmlFormPageBlocScolaire(BlocScolaire o) {
		...
		{ e("div").a("class", "w3-cell-row ").f();
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireArchive").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
					...
					{ e("form").a("action", "").a("id", "suggereBlocScolaireArchive").a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						{ e("div").a("class", "w3-card ").f();
							{ e("div").a("class", "w3-cell-row w3-indigo ").f();
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell ").f();
									...
									e("input")
										...
										.a("name", "setArchive")
										.a("id", "Page_archive")
										.a("onchange", "patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $('#BlocScolaireForm :input[name=\"pk\"]').val() }], 'setArchive', $(this).prop('checked'), function() { ajouterLueur($('#Page_archive')); }, function() { ajouterErreur($('#Page_archive')); }); ")
										;
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireSupprime").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
					...
					{ e("form").a("action", "").a("id", "suggereBlocScolaireSupprime").a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						{ e("div").a("class", "w3-card ").f();
							{ e("div").a("class", "w3-cell-row w3-indigo ").f();
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell ").f();
									...
									e("input")
										...
										.a("name", "setSupprime")
										.a("id", "Page_supprime")
										.a("onchange", "patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $('#BlocScolaireForm :input[name=\"pk\"]').val() }], 'setSupprime', $(this).prop('checked'), function() { ajouterLueur($('#Page_supprime')); }, function() { ajouterErreur($('#Page_supprime')); }); ")
										;
		...
		{ e("div").a("class", "w3-cell-row ").f();
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocHeureDebut").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell ").f();
									e("input")
										...
										.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureDebut', s, function() { ajouterLueur($('#Page_blocHeureDebut')); }, function() { ajouterErreur($('#Page_blocHeureDebut')); }); } ")
										.fg();
								} g("div");
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									...
									.a("onclick", "enleverLueur($('#Page_blocHeureDebut')); $('#Page_blocHeureDebut').val(null); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $('#BlocScolaireForm :input[name=\"pk\"]').val() }], 'setBlocHeureDebut', null, function() { ajouterLueur($('#Page_blocHeureDebut')); }, function() { ajouterErreur($('#Page_blocHeureDebut')); }); ")
										.f();
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocHeureFin").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell ").f();
									e("input")
										...
										.a("onclick", "enleverLueur($(this)); ")
										.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
										.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureFin', s, function() { ajouterLueur($('#Page_blocHeureFin')); }, function() { ajouterErreur($('#Page_blocHeureFin')); }); } ")
										.fg();
								} g("div");
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									{ e("button")
										.a("tabindex", "-1")
										.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-bar-item w3-indigo ")
									.a("onclick", "enleverLueur($('#Page_blocHeureFin')); $('#Page_blocHeureFin').val(null); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $('#BlocScolaireForm :input[name=\"pk\"]').val() }], 'setBlocHeureFin', null, function() { ajouterLueur($('#Page_blocHeureFin')); }, function() { ajouterErreur($('#Page_blocHeureFin')); }); ")
										.f();
										e("i").a("class", "far fa-eraser ").f().g("i");
									} g("button");
								} g("div");
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocPrixParMois").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								...
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									{ e("button")
										.a("tabindex", "-1")
										.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-bar-item w3-indigo ")
									.a("onclick", "enleverLueur($('#Page_blocPrixParMois')); $('#Page_blocPrixParMois').val(null); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $('#BlocScolaireForm :input[name=\"pk\"]').val() }], 'setBlocPrixParMois', null, function() { ajouterLueur($('#Page_blocPrixParMois')); }, function() { ajouterErreur($('#Page_blocPrixParMois')); }); ")
										.f();
										e("i").a("class", "far fa-eraser ").f().g("i");
									} g("button");
								} g("div");
		...
		{ e("div").a("class", "w3-cell-row ").f();
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocLundi").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocMardi").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocMercredi").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocJeudi").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireBlocVendredi").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeur")
							.a("class", "valeur ")
		...
		{ e("div").a("class", "w3-cell-row ").f();
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireAgeCle").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
					...
					{ e("form").a("action", "").a("id", "suggereBlocScolaireAgeCle").a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						{ e("div").a("class", "w3-card ").f();
							{ e("div").a("class", "w3-cell-row ").f();
								...
								{ e("div").a("class", "w3-cell ").f();
									...
									e("i").a("class", "far fa-search w3-xxlarge w3-cell w3-cell-middle ").f().g("i");
										e("input")
											.a("type", "text")
											.a("placeholder", "âge")
											.a("title", "La clé primaire de l'âge dans la base de données. ")
											.a("class", "valeurObjetSuggere suggereAgeCle w3-input w3-border w3-cell w3-cell-middle ")
											.a("name", "setAgeCle")
											.a("id", "Page_ageCle")
											.a("autocomplete", "off")
											.a("oninput", "suggereBlocScolaireAgeCle($('#' + ($(this).val() ? 'suggere' : 'form') + 'BlocScolaireAgeCle'), $('#listBlocScolaireAgeCle')); ")
										.fg();
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									{ e("ul").a("class", "w3-ul w3-hoverable ").a("id", "listBlocScolaireAgeCle").f();
									} g("ul");
									{ e("div").a("class", "w3-cell-row ").f();
										e("button")
											.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue ")
											.a("onclick", "postAgeScolaireVals({ blocCles: [ \"", o.getPk(), "\" ] }, function() { patchBlocScolaireVals([{ name: 'fq', value: 'pk:", o.getPk(), "' }], {}, function() { suggereBlocScolaireAgeCle($('#' + ($('#Page_ageCle').val() ? 'suggere' : 'form') + 'BlocScolaireAgeCle'), $('#listBlocScolaireAgeCle')); var $e = $('#Page_ageCle'); $e.html($e.val()); }, function() { ajouterErreur($('#Page_ageCle')); }); }, function() { ajouterErreur($('#Page_ageCle')); });")
											.f().sx("ajouter un âge")
										.g("button");
									} g("div");
								} g("div");
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formBlocScolaireInscriptionCles").a("style", "display: inline; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "valeurBlocCles")
							.a("class", "valeurBlocCles ")
					...
					{ e("form").a("action", "").a("id", "suggereBlocScolaireInscriptionCles").a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						{ e("div").a("class", "w3-card ").f();
							{ e("div").a("class", "w3-cell-row ").f();
								...
								{ e("div").a("class", "w3-cell ").f();
									...
									e("i").a("class", "far fa-search w3-xxlarge w3-cell w3-cell-middle ").f().g("i");
										e("input")
											...
											.a("autocomplete", "off")
											.a("oninput", "suggereBlocScolaireInscriptionCles($('#' + ($(this).val() ? 'suggere' : 'form') + 'BlocScolaireInscriptionCles'), $('#listBlocScolaireInscriptionCles')); ")
										.fg();
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									{ e("ul").a("class", "w3-ul w3-hoverable ").a("id", "listBlocScolaireInscriptionCles").f();
									} g("ul");
									{ e("div").a("class", "w3-cell-row ").f();
										e("button")
											.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-purple ")
											.a("onclick", "postInscriptionScolaireVals({ blocCles: [ \"", o.getPk(), "\" ] }, function() { patchBlocScolaireVals([{ name: 'fq', value: 'pk:", o.getPk(), "' }], {}, function() { suggereBlocScolaireInscriptionCles($('#' + ($('#Page_inscriptionCles').val() ? 'suggere' : 'form') + 'BlocScolaireInscriptionCles'), $('#listBlocScolaireInscriptionCles')); var $e = $('#Page_inscriptionCles'); $e.html($e.val()); }, function() { ajouterErreur($('#Page_inscriptionCles')); }); }, function() { ajouterErreur($('#Page_inscriptionCles')); });")
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell ").f();
								e("input")
									...
									.a("onclick", "enleverLueur($(this)); ")
									.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
									.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureDebut', s, function() { ajouterLueur($('#POST_blocHeureDebut')); }, function() { ajouterErreur($('#POST_blocHeureDebut')); }); } ")
									.fg();
							} g("div");
						} g("div");
					} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell ").f();
								e("input")
									...
									.a("onclick", "enleverLueur($(this)); ")
									.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
									.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureFin', s, function() { ajouterLueur($('#POST_blocHeureFin')); }, function() { ajouterErreur($('#POST_blocHeureFin')); }); } ")
									.fg();
							} g("div");
						} g("div");
					} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
								...
								{ e("div").a("class", "w3-cell-row ").f();
									e("button")
										.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue ")
										.a("onclick", "postAgeScolaireVals({ blocCles: [ \"", o.getPk(), "\" ] }, function() { patchBlocScolaireVals([{ name: 'fq', value: 'pk:", o.getPk(), "' }], {}, function() { suggereBlocScolaireAgeCle($('#' + ($('#POST_ageCle').val() ? 'suggere' : 'form') + 'BlocScolaireAgeCle'), $('#listBlocScolaireAgeCle')); var $e = $('#POST_ageCle'); $e.html($e.val()); }, function() { ajouterErreur($('#POST_ageCle')); }); }, function() { ajouterErreur($('#POST_ageCle')); });")
										.f().sx("ajouter un âge")
									.g("button");
								} g("div");
							} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell ").f();
								e("input")
									...
									.a("onclick", "enleverLueur($(this)); ")
									.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
									.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureDebut', s, function() { ajouterLueur($('#PATCH_blocHeureDebut')); }, function() { ajouterErreur($('#PATCH_blocHeureDebut')); }); } ")
									.fg();
							} g("div");
						} g("div");
					} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell ").f();
								e("input")
									...
									.a("onclick", "enleverLueur($(this)); ")
									.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
									.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureFin', s, function() { ajouterLueur($('#PATCH_blocHeureFin')); }, function() { ajouterErreur($('#PATCH_blocHeureFin')); }); } ")
									.fg();
							} g("div");
						} g("div");
					} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
								...
								{ e("div").a("class", "w3-cell-row ").f();
									e("button")
										.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue ")
										.a("onclick", "postAgeScolaireVals({ blocCles: [ \"", o.getPk(), "\" ] }, function() { patchBlocScolaireVals([{ name: 'fq', value: 'pk:", o.getPk(), "' }], {}, function() { suggereBlocScolaireAgeCle($('#' + ($('#PATCH_ageCle').val() ? 'suggere' : 'form') + 'BlocScolaireAgeCle'), $('#listBlocScolaireAgeCle')); var $e = $('#PATCH_ageCle'); $e.html($e.val()); }, function() { ajouterErreur($('#PATCH_ageCle')); }); }, function() { ajouterErreur($('#PATCH_ageCle')); });")
										.f().sx("ajouter un âge")
									.g("button");
								} g("div");
							} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell ").f();
								e("input")
									...
									.a("onclick", "enleverLueur($(this)); ")
									.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
									.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureDebut', s, function() { ajouterLueur($('#Recherche_blocHeureDebut')); }, function() { ajouterErreur($('#Recherche_blocHeureDebut')); }); } ")
									.fg();
							} g("div");
						} g("div");
					} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell ").f();
								e("input")
									...
									.a("onclick", "enleverLueur($(this)); ")
									.a("value", val == null ? "" : DateTimeFormatter.ofPattern("h:mm a", Locale.forLanguageTag("fr-FR")).format(val))
									.a("onchange", "var t = parseTime(this.value); if(t) { var s = dateFormat(t, 'HH MM'); patchBlocScolaireVal([{ name: 'fq', value: 'pk:' + $(\"#BlocScolaireForm :input[name='pk']\").val() }], 'setBlocHeureFin', s, function() { ajouterLueur($('#Recherche_blocHeureFin')); }, function() { ajouterErreur($('#Recherche_blocHeureFin')); }); } ")
									.fg();
							} g("div");
						} g("div");
					} g("div");
						...
						{ e("div").a("class", "w3-cell-row w3-padding ").f();
							{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
								...
								{ e("div").a("class", "w3-cell-row ").f();
									e("button")
										.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-blue ")
										.a("onclick", "postAgeScolaireVals({ blocCles: [ \"", o.getPk(), "\" ] }, function() { patchBlocScolaireVals([{ name: 'fq', value: 'pk:", o.getPk(), "' }], {}, function() { suggereBlocScolaireAgeCle($('#' + ($('#Recherche_ageCle').val() ? 'suggere' : 'form') + 'BlocScolaireAgeCle'), $('#listBlocScolaireAgeCle')); var $e = $('#Recherche_ageCle'); $e.html($e.val()); }, function() { ajouterErreur($('#Recherche_ageCle')); }); }, function() { ajouterErreur($('#Recherche_ageCle')); });")
										.f().sx("ajouter un âge")
									.g("button");
								} g("div");
							} g("div");
			...
			e("div").a("class", "").f();
				{ e("div").f();
					...
					if(start1 == 0) {
						...
						{ e("a").a("href", "/bloc?start=", start2, "&rows=", rows1).f();
					...
					if(rows1 <= 1) {
						...
						{ e("a").a("href", "/bloc?start=", start1, "&rows=", rows2).f();
							e("i").a("class", "fas fa-minus-square ").f().g("i");
						} g("a");
					}

					{ e("a").a("href", "/bloc?start=", start1, "&rows=", rows3).f();
					...
					if(start3 >= num) {
						...
						{ e("a").a("href", "/bloc?start=", start3, "&rows=", rows1).f();
		...
		{ p.e("div").a("class", "w3-cell-row w3-padding ").f();
			{ p.e("div").a("class", "w3-cell ").f();
				{ p.e("div").a("class", "w3-cell-row ").f();
					...
					{ p.e("form").a("action", "").a("id", "suggereFormBlocScolaire", id).a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); window.location.href='/bloc?q=objetSuggere:' + encodeURIComponent($('#suggereBlocScolaire", id, "').val()); return false; ").f();
						p.e("input")
							.a("type", "text")
							.a("placeholder", "rechercher blocs")
							.a("class", "suggereBlocScolaire w3-input w3-border w3-cell w3-cell-middle ")
							.a("name", "suggereBlocScolaire")
							.a("id", "suggereBlocScolaire", id)
							.a("autocomplete", "off")
							.a("oninput", "suggereBlocScolaireObjetSuggere( [ { 'name': 'q', 'value': 'objetSuggere:' + $(this).val() } ], $('#suggereListBlocScolaire", id, "')); ")
							.fg();
