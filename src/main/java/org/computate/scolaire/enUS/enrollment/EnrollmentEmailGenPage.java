...
public class EnrollmentEmailGenPage extends EnrollmentEmailGenPageGen<ClusterPage> {
			...
			e("div").a("class", "").f();
				{ e("div").f();
					...
					if(start1 == 0) {
						...
						{ e("a").a("href", "/enrollment-email?q=", query, fqs, sorts, "&start=", start2, "&rows=", rows1).f();
					...
					if(rows1 <= 1) {
						...
						{ e("a").a("href", "/enrollment-email?q=", query, fqs, sorts, "&start=", start1, "&rows=", rows2).f();
							e("i").a("class", "fas fa-minus-square ").f().g("i");
						} g("a");
					}

					{ e("a").a("href", "/enrollment-email?q=", query, fqs, sorts, "&start=", start1, "&rows=", rows3).f();
					...
					if(start3 >= num) {
						...
						{ e("a").a("href", "/enrollment-email?q=", query, fqs, sorts, "&start=", start3, "&rows=", rows1).f();
							e("i").a("class", "fas fa-arrow-square-right ").f().g("i");
						} g("a");
					}
						e("span").f().sx((start1 + 1), " - ", (start1 + rows1), " of ", num).g("span");
				} g("div");
				table1EnrollmentEmailGenPage();
		}
	...
	public void table1EnrollmentEmailGenPage() {
		{ e("table").a("class", "w3-table w3-bordered w3-striped w3-border w3-hoverable ").f();
			table2EnrollmentEmailGenPage();
		} g("table");
	}

	public void table2EnrollmentEmailGenPage() {
		thead1EnrollmentEmailGenPage();
		tbody1EnrollmentEmailGenPage();
		tfoot1EnrollmentEmailGenPage();
	}
	...
	public void tbody1EnrollmentEmailGenPage() {
		{ e("tbody").f();
			tbody2EnrollmentEmailGenPage();
		} g("tbody");
	}

	public void tbody2EnrollmentEmailGenPage() {
	...
	public void tfoot2EnrollmentEmailGenPage() {
		{ e("tr").f();
		...
		try {
			...
			{ p.e("div").a("class", "w3-bar ").f();
				...
				p.e("input")
					...
					.a("onkeyup", "if (event.keyCode === 13) { event.preventDefault(); window.location.href = '/enrollment-email?q=", query1, ":' + encodeURIComponent(this.value) + '", fqs, sorts, "&start=", start2, "&rows=", rows1, "'; }"); 
				...
				{ p.e("button")
					...
					.a("onclick", "window.location.href = '/enrollment-email?q=", query1, ":' + encodeURIComponent(this.previousElementSibling.value) + '", fqs, sorts, "&start=", start2, "&rows=", rows1, "'; ") 
					.f();
