		...
		try {
			sqlSchoolEnrollment(siteRequest, a -> {
				if(a.succeeded()) {
					userSchoolEnrollment(siteRequest, b -> {
						if(b.succeeded()) {
							aSearchSchoolEnrollment(siteRequest, false, true, "/enrollment-form", "FormSearchPage", c -> {
								if(c.succeeded()) {
									SearchList<SchoolEnrollment> listSchoolEnrollment = c.result();
									...
									LOGGER.error(String.format("formsearchpageSchoolEnrollment failed. ", c.cause()));
									errorSchoolEnrollment(siteRequest, eventHandler, c);
								}
							});
						} else {
		...
		try {
			sqlSchoolEnrollment(siteRequest, a -> {
				if(a.succeeded()) {
					userSchoolEnrollment(siteRequest, b -> {
						if(b.succeeded()) {
							aSearchSchoolEnrollment(siteRequest, false, true, "/enrollment-pdf", "PdfSearchPage", c -> {
								if(c.succeeded()) {
									SearchList<SchoolEnrollment> listSchoolEnrollment = c.result();
									...
									LOGGER.error(String.format("pdfsearchpageSchoolEnrollment failed. ", c.cause()));
									errorSchoolEnrollment(siteRequest, eventHandler, c);
								}
							});
						} else {
		...
		try {
			sqlSchoolEnrollment(siteRequest, a -> {
				if(a.succeeded()) {
					userSchoolEnrollment(siteRequest, b -> {
						if(b.succeeded()) {
							aSearchSchoolEnrollment(siteRequest, false, true, "/enrollment-email", "EmailSearchPage", c -> {
								if(c.succeeded()) {
									SearchList<SchoolEnrollment> listSchoolEnrollment = c.result();
									...
									LOGGER.error(String.format("emailsearchpageSchoolEnrollment failed. ", c.cause()));
									errorSchoolEnrollment(siteRequest, eventHandler, c);
								}
							});
						} else {
