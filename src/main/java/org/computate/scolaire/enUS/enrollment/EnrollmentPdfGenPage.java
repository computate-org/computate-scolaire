...
public class EnrollmentPdfGenPage extends EnrollmentPdfGenPageGen<ClusterPage> {
	...
	@Override public void htmlBodyEnrollmentPdfGenPage() {
		...
		if(listSchoolEnrollment == null || listSchoolEnrollment.size() == 0) {
			...
			{ e("h1").f();
				{ e("a").a("href", "/enrollment/pdf").a("class", "w3-bar-item w3-btn w3-center w3-block w3-purple w3-hover-purple ").f();
			...
			e("div").a("class", "").f();
				{ e("div").f();
					...
					if(start1 == 0) {
						...
						{ e("a").a("href", "/enrollment/pdf?q=", query, "&start=", start2, "&rows=", rows1).f();
					...
					if(rows1 <= 1) {
						...
						{ e("a").a("href", "/enrollment/pdf?q=", query, "&start=", start1, "&rows=", rows2).f();
							e("i").a("class", "fas fa-minus-square ").f().g("i");
						} g("a");
					}

					{ e("a").a("href", "/enrollment/pdf?q=", query, "&start=", start1, "&rows=", rows3).f();
					...
					if(start3 >= num) {
						...
						{ e("a").a("href", "/enrollment/pdf?q=", query, "&start=", start3, "&rows=", rows1).f();
		...
		htmlSuggestEnrollmentPdfGenPage(this, null);
		g("div");
	}
	...
	/**
	**/
	public static void htmlSuggestEnrollmentPdfGenPage(PageLayout p, String id) {
		{ p.e("div").a("class", "w3-cell-row ").f();
			...
			{ p.e("div").a("class", "w3-cell ").f();
				{ p.e("a").a("id", "refreshAllEnrollmentPdfGenPage", id).a("href", "/enrollment/pdf").a("class", "").a("onclick", "patchSchoolEnrollmentVals([], {}, function() { addGlow($('#refreshAllEnrollmentPdfGenPage", id, "')); }, function() { addError($('#refreshAllEnrollmentPdfGenPage", id, "')); }); return false; ").f();
		...
		{ p.e("div").a("class", "w3-cell-row w3-padding ").f();
			{ p.e("div").a("class", "w3-cell ").f();
				{ p.e("div").a("class", "w3-cell-row ").f();
					...
					{ p.e("form").a("action", "").a("id", "suggestFormSchoolEnrollment", id).a("style", "display: inline-block; width: 100%; ").a("onsubmit", "event.preventDefault(); window.location.href='/enrollment/pdf?q=objectSuggest:' + encodeURIComponent($('#suggestSchoolEnrollment", id, "').val()); return false; ").f();
						p.e("input")
							.a("type", "text")
