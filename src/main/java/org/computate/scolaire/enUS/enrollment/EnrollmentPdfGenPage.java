...
public class EnrollmentPdfGenPage extends EnrollmentPdfGenPageGen<ClusterPage> {
	...
	public void htmlBodyFormsEnrollmentPdfGenPage() {
		...
		htmlSuggestEnrollmentPdfGenPage(this, null, listSchoolEnrollment);
	}

	/**
	**/
	public static void htmlSuggestEnrollmentPdfGenPage(PageLayout p, String id, SearchList<SchoolEnrollment> listSchoolEnrollment) {
