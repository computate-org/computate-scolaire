...
public class EnrollmentGenPage extends EnrollmentGenPageGen<ClusterPage> {
	...
	public void htmlBodyFormsEnrollmentGenPage() {
		...
		htmlSuggestEnrollmentGenPage(this, null, listSchoolEnrollment);
	}

	/**
	**/
	public static void htmlSuggestEnrollmentGenPage(PageLayout p, String id, SearchList<SchoolEnrollment> listSchoolEnrollment) {
