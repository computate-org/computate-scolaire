	...
	**/
	public static void htmlSuggestEnrollmentGenPage(PageLayout p, String id) {
		...
		if(
			...
			{ p.e("div").a("class", "").f();
				{ p.e("button").a("id", "refreshAllEnrollmentGenPage", id).a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-purple ").a("onclick", "patchSchoolEnrollmentVals([], {}, function() { addGlow($('#refreshAllEnrollmentGenPage", id, "')); }, function() { addError($('#refreshAllEnrollmentGenPage", id, "')); }); ").f();
