...
public class PageDesignEnUSGenApiServiceImpl implements PageDesignEnUSGenApiService {
				...
				for(String entityVar : entityVars) {
					...
					case "childDesignKeys":
						for(Long l : Optional.ofNullable(jsonObject.getJsonArray(entityVar)).orElse(new JsonArray()).stream().map(a -> Long.parseLong((String)a)).collect(Collectors.toList())) {
							if(l != null) {
								SearchList<org.computate.scolaire.enUS.design.PageDesign> searchList = new SearchList<org.computate.scolaire.enUS.design.PageDesign>();
								searchList.setQuery("*:*");
								searchList.setStore(true);
								searchList.setC(org.computate.scolaire.enUS.design.PageDesign.class);
					...
					case "htmlPartKeys":
						for(Long l : Optional.ofNullable(jsonObject.getJsonArray(entityVar)).orElse(new JsonArray()).stream().map(a -> Long.parseLong((String)a)).collect(Collectors.toList())) {
							if(l != null) {
								SearchList<org.computate.scolaire.enUS.html.part.HtmlPart> searchList = new SearchList<org.computate.scolaire.enUS.html.part.HtmlPart>();
								searchList.setQuery("*:*");
								searchList.setStore(true);
								searchList.setC(org.computate.scolaire.enUS.html.part.HtmlPart.class);
								searchList.addFilterQuery("deleted_indexed_boolean:false");
								searchList.addFilterQuery("archived_indexed_boolean:false");
								searchList.addFilterQuery((inheritPk ? "inheritPk" : "pk") + "_indexed_long:" + l);
								searchList.initDeepSearchList(siteRequest);
					...
					case "designAdmin":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designAdmin", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designAdmin failed", b.cause())));
							});
						}));
						break;
					case "designIgnoreEmptyChildName":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designIgnoreEmptyChildName", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designIgnoreEmptyChildName failed", b.cause())));
							});
						}));
						break;
					case "designIgnorePaymentsNotPastDue":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designIgnorePaymentsNotPastDue", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designIgnorePaymentsNotPastDue failed", b.cause())));
							});
						}));
						break;
					case "designIgnorePaymentsPastDue":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designIgnorePaymentsPastDue", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designIgnorePaymentsPastDue failed", b.cause())));
							});
						}));
						break;
					case "designFilterEnrollmentKey":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designFilterEnrollmentKey", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designFilterEnrollmentKey failed", b.cause())));
							});
						}));
						break;
					case "designEnrollmentSortMonthDayOfBirth":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designEnrollmentSortMonthDayOfBirth", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designEnrollmentSortMonthDayOfBirth failed", b.cause())));
							});
						}));
						break;
					case "designEnrollmentSortGroupName":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designEnrollmentSortGroupName", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designEnrollmentSortGroupName failed", b.cause())));
							});
						}));
						break;
					case "designEnrollmentSortChildName":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "designEnrollmentSortChildName", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.designEnrollmentSortChildName failed", b.cause())));
							});
						}));
						break;
					case "searchYears":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "searchYears", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.searchYears failed", b.cause())));
							});
						}));
						break;
					case "searchPayments":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "searchPayments", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.searchPayments failed", b.cause())));
							});
						}));
						break;
					case "searchCurrentPayments":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "searchCurrentPayments", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.searchCurrentPayments failed", b.cause())));
							});
						}));
						break;
					case "pagePdf":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "pagePdf", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.pagePdf failed", b.cause())));
							});
						}));
						break;
					case "pageCsv":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "pageCsv", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
								else
									a.handle(Future.failedFuture(new Exception("value PageDesign.pageCsv failed", b.cause())));
							});
						}));
						break;
					}
				...
				switch(methodName) {
					...
					case "setDesignAdmin":
						if(jsonObject.getBoolean(methodName) == null) {
							...
							o2.setDesignAdmin(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
						...
						break;
					case "setDesignIgnoreEmptyChildName":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designIgnoreEmptyChildName")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignIgnoreEmptyChildName(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designIgnoreEmptyChildName", o2.jsonDesignIgnoreEmptyChildName())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setDesignIgnorePaymentsNotPastDue":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designIgnorePaymentsNotPastDue")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignIgnorePaymentsNotPastDue(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designIgnorePaymentsNotPastDue", o2.jsonDesignIgnorePaymentsNotPastDue())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setDesignIgnorePaymentsPastDue":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designIgnorePaymentsPastDue")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignIgnorePaymentsPastDue(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designIgnorePaymentsPastDue", o2.jsonDesignIgnorePaymentsPastDue())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setDesignFilterEnrollmentKey":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designFilterEnrollmentKey")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignFilterEnrollmentKey(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designFilterEnrollmentKey", o2.jsonDesignFilterEnrollmentKey())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setDesignEnrollmentSortMonthDayOfBirth":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designEnrollmentSortMonthDayOfBirth")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignEnrollmentSortMonthDayOfBirth(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designEnrollmentSortMonthDayOfBirth", o2.jsonDesignEnrollmentSortMonthDayOfBirth())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setDesignEnrollmentSortGroupName":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designEnrollmentSortGroupName")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignEnrollmentSortGroupName(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designEnrollmentSortGroupName", o2.jsonDesignEnrollmentSortGroupName())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setDesignEnrollmentSortChildName":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "designEnrollmentSortChildName")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setDesignEnrollmentSortChildName(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "designEnrollmentSortChildName", o2.jsonDesignEnrollmentSortChildName())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setSearchYears":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "searchYears")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setSearchYears(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "searchYears", o2.jsonSearchYears())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setSearchPayments":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "searchPayments")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setSearchPayments(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "searchPayments", o2.jsonSearchPayments())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
						...
						break;
					case "setSearchCurrentPayments":
						if(jsonObject.getBoolean(methodName) == null) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_removeD)
										.execute(Tuple.of(pk, "searchCurrentPayments")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
							...
							o2.setSearchCurrentPayments(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "searchCurrentPayments", o2.jsonSearchCurrentPayments())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setPagePdf":
						if(jsonObject.getBoolean(methodName) == null) {
							...
							o2.setPagePdf(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
					...
					case "setPageCsv":
						if(jsonObject.getBoolean(methodName) == null) {
							...
							o2.setPageCsv(jsonObject.getBoolean(methodName));
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
	...
	@Override
	public void designcsvsearchpagePageDesign(OperationRequest operationRequest, Handler<AsyncResult<OperationResponse>> eventHandler) {
		SiteRequestEnUS siteRequest = generateSiteRequestEnUSForPageDesign(siteContext, operationRequest);
		siteRequest.setRequestUri("/csv");
		siteRequest.setRequestMethod("DesignCsvSearchPage");
		try {
			{
				userPageDesign(siteRequest, b -> {
					if(b.succeeded()) {
						aSearchPageDesign(siteRequest, false, true, false, "/csv", "DesignCsvSearchPage", c -> {
							if(c.succeeded()) {
								SearchList<PageDesign> listPageDesign = c.result();
								designcsvsearchpagePageDesignResponse(listPageDesign, d -> {
									if(d.succeeded()) {
										eventHandler.handle(Future.succeededFuture(d.result()));
										LOGGER.info(String.format("designcsvsearchpagePageDesign succeeded. "));
									} else {
										LOGGER.error(String.format("designcsvsearchpagePageDesign failed. ", d.cause()));
										errorPageDesign(siteRequest, eventHandler, d);
									}
								});
							} else {
								LOGGER.error(String.format("designcsvsearchpagePageDesign failed. ", c.cause()));
								errorPageDesign(siteRequest, eventHandler, c);
							}
						});
					} else {
						LOGGER.error(String.format("designcsvsearchpagePageDesign failed. ", b.cause()));
						errorPageDesign(siteRequest, eventHandler, b);
					}
				});
			}
		} catch(Exception ex) {
			LOGGER.error(String.format("designcsvsearchpagePageDesign failed. ", ex));
			errorPageDesign(siteRequest, eventHandler, Future.failedFuture(ex));
		}
	}
	...
	public void designcsvsearchpagePageDesignResponse(SearchList<PageDesign> listPageDesign, Handler<AsyncResult<OperationResponse>> eventHandler) {
		SiteRequestEnUS siteRequest = listPageDesign.getSiteRequest_();
		try {
			response200DesignCsvSearchPagePageDesign(listPageDesign, a -> {
				if(a.succeeded()) {
					eventHandler.handle(Future.succeededFuture(a.result()));
				} else {
					LOGGER.error(String.format("designcsvsearchpagePageDesignResponse failed. ", a.cause()));
					errorPageDesign(siteRequest, eventHandler, a);
				}
			});
		} catch(Exception ex) {
			LOGGER.error(String.format("designcsvsearchpagePageDesignResponse failed. ", ex));
			errorPageDesign(siteRequest, null, Future.failedFuture(ex));
		}
	}
	public void response200DesignCsvSearchPagePageDesign(SearchList<PageDesign> listPageDesign, Handler<AsyncResult<OperationResponse>> eventHandler) {
		try {
			SiteRequestEnUS siteRequest = listPageDesign.getSiteRequest_();
			QueryResponse responseSearch = listPageDesign.getQueryResponse();
			SolrDocumentList solrDocuments = listPageDesign.getSolrDocumentList();
			...
			LOGGER.error(String.format("response200DesignCsvSearchPagePageDesign failed. ", e));
			eventHandler.handle(Future.failedFuture(e));
		}
	}
