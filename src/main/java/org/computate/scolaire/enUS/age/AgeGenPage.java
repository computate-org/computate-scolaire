...
public class AgeGenPage extends AgeGenPageGen<ClusterPage> {
	...
	public void htmlFormPageSchoolAge(SchoolAge o) {
		...
		{ e("div").a("class", "w3-cell-row ").f();
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formSchoolAgeAgeStart").a("style", "display: inline-block; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "value")
							.a("class", "value ")
					...
					{ e("form").a("action", "").a("id", "suggestSchoolAgeAgeStart").a("style", "display: inline-block; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						{ e("div").a("class", "w3-card ").f();
							{ e("div").a("class", "w3-cell-row w3-blue ").f();
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell ").f();
									...
									e("input")
										...
										.a("onchange", "patchSchoolAgeVal([{ name: 'fq', value: 'pk:' + $('#SchoolAgeForm :input[name=\"pk\"]').val() }], 'setAgeStart', $(this).val(), function() { addGlow($('#Page_ageStart')); }, function() { ajouterErreur($('#Page_ageStart')); }); ")
								...
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									...
									.a("onclick", "removeGlow($('#Page_ageStart')); $('#Page_ageStart').val(null); patchSchoolAgeVal([{ name: 'fq', value: 'pk:' + $('#SchoolAgeForm :input[name=\"pk\"]').val() }], 'setAgeStart', null, $('#Page_ageStart'), function() { addGlow($('#Page_ageStart')); }, function() { ajouterErreur($('#Page_ageStart')); }); ")
										.f();
			...
			{ e("div").a("class", "w3-cell w3-cell-middle w3-center w3-mobile ").f();
				{ e("div").a("class", "w3-padding ").f();
					{ e("form").a("action", "").a("id", "formSchoolAgeAgeEnd").a("style", "display: inline-block; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
							.a("type", "hidden")
							.a("name", "value")
							.a("class", "value ")
					...
					{ e("form").a("action", "").a("id", "suggestSchoolAgeAgeEnd").a("style", "display: inline-block; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						{ e("div").a("class", "w3-card ").f();
							{ e("div").a("class", "w3-cell-row w3-blue ").f();
							...
							{ e("div").a("class", "w3-cell-row w3-padding ").f();
								{ e("div").a("class", "w3-cell ").f();
									...
									e("input")
										...
										.a("id", "Page_ageEnd")
										.a("onclick", "removeGlow($(this)); ")
										.a("onchange", "patchSchoolAgeVal([{ name: 'fq', value: 'pk:' + $('#SchoolAgeForm :input[name=\"pk\"]').val() }], 'setAgeEnd', $(this).val(), function() { addGlow($('#Page_ageEnd')); }, function() { ajouterErreur($('#Page_ageEnd')); }); ")
										.a("value", o.strAgeEnd())
									.fg();
								...
								{ e("div").a("class", "w3-cell w3-left-align w3-cell-top ").f();
									{ e("button")
										.a("class", "w3-btn w3-round w3-border w3-border-black w3-ripple w3-padding w3-bar-item w3-blue ")
									.a("onclick", "removeGlow($('#Page_ageEnd')); $('#Page_ageEnd').val(null); patchSchoolAgeVal([{ name: 'fq', value: 'pk:' + $('#SchoolAgeForm :input[name=\"pk\"]').val() }], 'setAgeEnd', null, $('#Page_ageEnd'), function() { addGlow($('#Page_ageEnd')); }, function() { ajouterErreur($('#Page_ageEnd')); }); ")
										.f();
										e("i").a("class", "far fa-eraser ").f().g("i");
									} g("button");
								} g("div");
	...
	@Override public void htmlBodyAgeGenPage() {
		...
		if(listSchoolAge == null || listSchoolAge.size() == 0) {
			...
			if(pageH1 != null) {
				{ e("h1").f();
					if(contextIconCssClasses != null)
						e("i").a("class", contextIconCssClasses + " site-menu-icon ").f().g("i");
					e("span").a("class", " ").f().sx("an age").g("span");
				} g("h1");
		...
		if(listSchoolAge != null && listSchoolAge.size() == 1 && params.getJsonObject("query").getString("q").equals("*:*")) {
			...
			{ e("div").a("class", "").f();
				...
				if(o.getPk() != null) {
					{ e("form").a("action", "").a("id", "SchoolAgeForm").a("style", "display: inline-block; ").a("onsubmit", "event.preventDefault(); return false; ").f();
						e("input")
						.a("name", "pk")
						.a("class", "valuePk")
						.a("type", "hidden")
