...
public class SchoolAgeEnUSGenApiServiceImpl implements SchoolAgeEnUSGenApiService {
	...
	public void postSchoolAge(JsonObject body, OperationRequest operationRequest, Handler<AsyncResult<OperationResponse>> eventHandler) {
		...
		siteRequest.setRequestUri("/api/age");
			...
			if(jsonObject != null) {
				...
				for(String entityVar : entityVars) {
								...
								if(l2 != null) {
									futures.add(Future.future(a -> {
										tx.preparedQuery(SiteContextEnUS.SQL_addA)
												.execute(Tuple.of(l2, "ageKey", pk, "blockKeys")
												, b
										-> {
											if(b.succeeded())
												a.handle(Future.succeededFuture());
					...
					case "sessionKey":
						{
							...
							if(l != null) {
								SearchList<org.computate.scolaire.enUS.session.SchoolSession> searchList = new SearchList<org.computate.scolaire.enUS.session.SchoolSession>();
								searchList.setQuery("*:*");
								searchList.setStore(true);
								searchList.setC(org.computate.scolaire.enUS.session.SchoolSession.class);
								searchList.addFilterQuery("deleted_indexed_boolean:false");
								searchList.addFilterQuery("archived_indexed_boolean:false");
								searchList.addFilterQuery((inheritPk ? "inheritPk" : "pk") + "_indexed_long:" + l);
								searchList.initDeepSearchList(siteRequest);
								...
								if(l2 != null) {
									futures.add(Future.future(a -> {
										tx.preparedQuery(SiteContextEnUS.SQL_addA)
												.execute(Tuple.of(l2, "ageKeys", pk, "sessionKey")
												, b
										-> {
											if(b.succeeded())
												a.handle(Future.succeededFuture());
					...
					case "yearKey":
						{
							...
							if(l != null) {
								...
								if(l2 != null) {
									futures.add(Future.future(a -> {
										tx.preparedQuery(SiteContextEnUS.SQL_addA)
												.execute(Tuple.of(l2, "ageKeys", pk, "yearKey")
												, b
										-> {
											if(b.succeeded())
												a.handle(Future.succeededFuture());
					...
					case "ageStart":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "ageStart", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
					...
					case "ageEnd":
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_setD)
									.execute(Tuple.of(pk, "ageEnd", Optional.ofNullable(jsonObject.getValue(entityVar)).map(s -> s.toString()).orElse(null))
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
	...
	public void putimportSchoolAge(JsonObject body, OperationRequest operationRequest, Handler<AsyncResult<OperationResponse>> eventHandler) {
		SiteRequestEnUS siteRequest = generateSiteRequestEnUSForSchoolAge(siteContext, operationRequest, body);
		siteRequest.setRequestUri("/api/age/import");
	...
	public void putmergeSchoolAge(JsonObject body, OperationRequest operationRequest, Handler<AsyncResult<OperationResponse>> eventHandler) {
		SiteRequestEnUS siteRequest = generateSiteRequestEnUSForSchoolAge(siteContext, operationRequest, body);
		siteRequest.setRequestUri("/api/age/merge");
	...
	public void putcopySchoolAge(JsonObject body, OperationRequest operationRequest, Handler<AsyncResult<OperationResponse>> eventHandler) {
		SiteRequestEnUS siteRequest = generateSiteRequestEnUSForSchoolAge(siteContext, operationRequest, body);
		siteRequest.setRequestUri("/api/age/copy");
				...
				for(Integer i = 0; i < entityVars.size(); i++) {
					...
					case "blockKeys":
						for(Long l : Optional.ofNullable(jsonObject.getJsonArray(entityVar)).orElse(new JsonArray()).stream().map(a -> Long.parseLong((String)a)).collect(Collectors.toList())) {
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_addA)
										.execute(Tuple.of(l, "ageKey", pk, "blockKeys")
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "sessionKey":
						...
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_addA)
									.execute(Tuple.of(l, "ageKeys", pk, "sessionKey")
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
					...
					case "yearKey":
						...
						futures.add(Future.future(a -> {
							tx.preparedQuery(SiteContextEnUS.SQL_addA)
									.execute(Tuple.of(l, "ageKeys", pk, "yearKey")
									, b
							-> {
								if(b.succeeded())
									a.handle(Future.succeededFuture());
											...
											aSearchSchoolAge(siteRequest, false, true, true, "/api/age", "PATCH", d -> {
												if(d.succeeded()) {
													...
													if(listSchoolAge.getQueryResponse().getResults().getNumFound() > 1
														...
														errorSchoolAge(siteRequest, eventHandler, Future.failedFuture(message));
													} else {
				...
				switch(methodName) {
					...
					case "setBlockKeys":
						...
						if(o.getBlockKeys() != null) {
							for(Long l :  o.getBlockKeys()) {
								if(l != null && (setBlockKeysValues == null || !setBlockKeysValues2.contains(l))) {
									futures.add(Future.future(a -> {
					...
					case "setAgeStart":
						if(jsonObject.getString(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "ageStart", o2.jsonAgeStart())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
					...
					case "setAgeEnd":
						if(jsonObject.getString(methodName) == null) {
							...
							futures.add(Future.future(a -> {
								tx.preparedQuery(SiteContextEnUS.SQL_setD)
										.execute(Tuple.of(pk, "ageEnd", o2.jsonAgeEnd())
										, b
								-> {
									if(b.succeeded())
										a.handle(Future.succeededFuture());
	...
	public void getSchoolAge(OperationRequest operationRequest, Handler<AsyncResult<OperationResponse>> eventHandler) {
		...
		siteRequest.setRequestUri("/api/age/{id}");
	...
	public void createSchoolAge(SiteRequestEnUS siteRequest, Handler<AsyncResult<SchoolAge>> eventHandler) {
		try {
			...
			tx.preparedQuery(SiteContextEnUS.SQL_create)
					...
					.execute(Tuple.of(SchoolAge.class.getCanonicalName(), userId, created.toOffsetDateTime())
					, createAsync
			-> {
	...
	public void aSearchSchoolAgeFq(String uri, String apiMethod, SearchList<SchoolAge> searchList, String entityVar, String valueIndexed, String varIndexed) {
		...
		if(StringUtils.startsWith(valueIndexed, "[")) {
			...
			String fq1 = fqs[0].equals("*") ? fqs[0] : SchoolAge.staticSolrFqForClass(entityVar, searchList.getSiteRequest_(), fqs[0]);
			String fq2 = fqs[1].equals("*") ? fqs[1] : SchoolAge.staticSolrFqForClass(entityVar, searchList.getSiteRequest_(), fqs[1]);
			searchList.addFilterQuery(varIndexed + ":[" + fq1 + " TO " + fq2 + "]");
		} else {
			searchList.addFilterQuery(varIndexed + ":" + SchoolAge.staticSolrFqForClass(entityVar, searchList.getSiteRequest_(), valueIndexed));
		}
	}
	...
	public void aSearchSchoolAge(SiteRequestEnUS siteRequest, Boolean populate, Boolean store, Boolean modify, String uri, String apiMethod, Handler<AsyncResult<SearchList<SchoolAge>>> eventHandler) {
		try {
			SearchList<SchoolAge> searchList = aSearchSchoolAgeList(siteRequest, populate, store, modify, uri, apiMethod);
	...
	public SearchList<SchoolAge> aSearchSchoolAgeList(SiteRequestEnUS siteRequest, Boolean populate, Boolean store, Boolean modify, String uri, String apiMethod) {
		OperationRequest operationRequest = siteRequest.getOperationRequest();
		...
		aSearchSchoolAge2(siteRequest, populate, store, modify, uri, apiMethod, searchList);
		searchList.initDeepForClass(siteRequest);
		return searchList;
	}
	public void aSearchSchoolAge2(SiteRequestEnUS siteRequest, Boolean populate, Boolean store, Boolean modify, String uri, String apiMethod, SearchList<SchoolAge> searchList) {
	}
