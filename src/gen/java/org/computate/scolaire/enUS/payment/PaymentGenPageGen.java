...
public abstract class PaymentGenPageGen<DEV> extends ClusterPage {
	...
	public void patchRequestPaymentGenPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		PaymentGenPage original = (PaymentGenPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
