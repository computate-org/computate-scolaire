...
public abstract class DesignPdfPageGen<DEV> extends DesignPdfGenPage {
	 ...
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:paymentBlocks">Find the entity paymentBlocks in Solr</a>
	 * <br/>
	...
	public DesignPdfPage addPaymentBlocks(SchoolPayment...objets) {
		for(SchoolPayment o : objets) {
			addPaymentBlocks(o);
		}
		return (DesignPdfPage)this;
	}
	public DesignPdfPage addPaymentBlocks(SchoolPayment o) {
		if(o != null && !paymentBlocks.contains(o))
			this.paymentBlocks.add(o);
		return (DesignPdfPage)this;
	}
	protected DesignPdfPage paymentBlocksInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:paymentGroups">Find the entity paymentGroups in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public DesignPdfPage addPaymentGroups(SchoolPayment...objets) {
		for(SchoolPayment o : objets) {
			addPaymentGroups(o);
		}
		return (DesignPdfPage)this;
	}
	public DesignPdfPage addPaymentGroups(SchoolPayment o) {
		if(o != null && !paymentGroups.contains(o))
			this.paymentGroups.add(o);
		return (DesignPdfPage)this;
	}
	protected DesignPdfPage paymentGroupsInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:paymentBlock">Find the entity paymentBlock in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected DesignPdfPage paymentBlockInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:paymentGroup">Find the entity paymentGroup in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected DesignPdfPage paymentGroupInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.design.DesignPdfPage&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:paymentPayment">Find the entity paymentPayment in Solr</a>
	 * <br/>
	 * @param c is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected DesignPdfPage paymentPaymentInit() {
	...
	public Object obtainDesignPdfPage(String var) {
		...
		switch(var) {
			...
			case "paymentBlocks":
				return oDesignPdfPage.paymentBlocks;
			case "paymentGroups":
				return oDesignPdfPage.paymentGroups;
			case "paymentBlock":
				return oDesignPdfPage.paymentBlock;
			case "paymentGroup":
				return oDesignPdfPage.paymentGroup;
			case "paymentPayment":
				return oDesignPdfPage.paymentPayment;
			case "paymentFacets":
