...
public abstract class GuardianPageGen<DEV> extends GuardianGenPage {
	...
	public void patchRequestGuardianPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		GuardianPage original = (GuardianPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestGuardianGenPage();
		}
	}
