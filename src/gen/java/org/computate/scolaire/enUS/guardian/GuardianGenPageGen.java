...
public abstract class GuardianGenPageGen<DEV> extends ClusterPage {
	...
	public void patchRequestGuardianGenPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		GuardianGenPage original = (GuardianGenPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
