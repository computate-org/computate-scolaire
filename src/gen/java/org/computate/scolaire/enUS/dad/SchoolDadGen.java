...
public abstract class SchoolDadGen<DEV> extends Cluster {
	...
	public void inputEnrollmentKeys(String classApiMethodMethod) {
		...
		if(
			...
			e("input")
				...
				.a("autocomplete", "off");
				a("oninput", "suggestSchoolDadEnrollmentKeys($(this).val() ? [ { 'name': 'q', 'value': 'objectSuggest:' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,pageUrlPk,enrollmentCompleteName' } ] : [", pk == null ? "" : "{'name':'fq','value':'dadKeys:" + pk + "'}", "], $('#listSchoolDadEnrollmentKeys_", classApiMethodMethod, "'), ", pk, "); ");
	...
	public String sqlPersonOccupation() {
		return personOccupation;
	}
	...
	public String sqlPersonPhoneNumber() {
		return personPhoneNumber;
	}
	...
	public String sqlPersonRelation() {
		return personRelation;
	}
	...
	public Boolean sqlPersonReceiveEmail() {
		return personReceiveEmail;
	}
	...
	public Boolean sqlPersonEmergencyContact() {
		return personEmergencyContact;
	}
	...
	public Boolean sqlPersonPickup() {
		return personPickup;
	}
	...
	public String sqlDadCompleteName() {
		return dadCompleteName;
	}
	...
	public Object defineSchoolDad(String var, String val) {
		switch(var.toLowerCase()) {
			...
			case "personoccupation":
				...
				saves.add("personOccupation");
				return val;
			case "personphonenumber":
				if(val != null)
					setPersonPhoneNumber(val);
				saves.add("personPhoneNumber");
				return val;
			case "personemail":
				if(val != null)
					setPersonEmail(val);
				saves.add("personEmail");
				return val;
			case "personsms":
				if(val != null)
					setPersonSms(val);
			...
			case "personreceiveemail":
				...
				saves.add("personReceiveEmail");
				return val;
			case "personemergencycontact":
				if(val != null)
					setPersonEmergencyContact(val);
				saves.add("personEmergencyContact");
				return val;
			case "personpickup":
				if(val != null)
					setPersonPickup(val);
				saves.add("personPickup");
				return val;
			case "photo":
				if(val != null)
					setPhoto(val);
	...
	public Object defineSchoolDad(String var, Object val) {
		switch(var.toLowerCase()) {
			case "personfirstname":
			...
			case "personoccupation":
				if(val instanceof String)
					setPersonOccupation((String)val);
				saves.add("personOccupation");
				return val;
			case "personphonenumber":
				if(val instanceof String)
					setPersonPhoneNumber((String)val);
				saves.add("personPhoneNumber");
				return val;
			case "personemail":
				if(val instanceof String)
					setPersonEmail((String)val);
				saves.add("personEmail");
				return val;
			case "personsms":
				if(val instanceof Boolean)
					setPersonSms((Boolean)val);
				saves.add("personSms");
				return val;
			case "personreceiveemail":
				if(val instanceof Boolean)
					setPersonReceiveEmail((Boolean)val);
				saves.add("personReceiveEmail");
				return val;
			case "personemergencycontact":
				if(val instanceof Boolean)
					setPersonEmergencyContact((Boolean)val);
				saves.add("personEmergencyContact");
				return val;
			case "personpickup":
				if(val instanceof Boolean)
					setPersonPickup((Boolean)val);
				saves.add("personPickup");
				return val;
			case "photo":
				if(val instanceof String)
