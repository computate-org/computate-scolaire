...
public abstract class DadPageGen<DEV> extends DadGenPage {
	...
	public void patchRequestDadPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		DadPage original = (DadPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestDadGenPage();
		}
	}
