...
public abstract class EnrollmentGenPageGen<DEV> extends ClusterPage {
	...
	public void patchRequestEnrollmentGenPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		EnrollmentGenPage original = (EnrollmentGenPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
