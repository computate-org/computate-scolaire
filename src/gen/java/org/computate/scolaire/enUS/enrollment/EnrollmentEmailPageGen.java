...
public abstract class EnrollmentEmailPageGen<DEV> extends EnrollmentEmailGenPage {
	protected static final Logger LOGGER = LoggerFactory.getLogger(EnrollmentEmailPage.class);
	...
	protected EnrollmentEmailPage listPageDesignInit() {
	...
	protected EnrollmentEmailPage pageDesignInit() {
	...
	public Object obtainEnrollmentEmailPage(String var) {
		...
		switch(var) {
			...
			case "listPageDesign":
				return oEnrollmentEmailPage.listPageDesign;
			case "pageDesign":
				return oEnrollmentEmailPage.pageDesign;
			case "yearSearch":
