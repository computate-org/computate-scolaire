...
public abstract class EnrollmentDesignGenPageGen<DEV> extends ClusterPage {
	...
	public void patchRequestEnrollmentDesignGenPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		EnrollmentDesignGenPage original = (EnrollmentDesignGenPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
