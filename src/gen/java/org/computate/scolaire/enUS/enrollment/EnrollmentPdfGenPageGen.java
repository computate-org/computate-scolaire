...
public abstract class EnrollmentPdfGenPageGen<DEV> extends ClusterPage {
	...
	public void patchRequestEnrollmentPdfGenPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		EnrollmentPdfGenPage original = (EnrollmentPdfGenPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
