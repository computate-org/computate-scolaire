...
public abstract class EnrollmentDesignPageGen<DEV> extends EnrollmentDesignGenPage {
	...
	public void patchRequestEnrollmentDesignPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		EnrollmentDesignPage original = (EnrollmentDesignPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestEnrollmentDesignGenPage();
		}
	}
