...
public abstract class SchoolSessionGen<DEV> extends Cluster {
	 ...
	 * Il est construit avant d'être initialisé avec le constructeur par défaut List<Long>(). 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.session.SchoolSession&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:sessionKeys">Trouver l'entité sessionKeys dans Solr</a>
	 * <br/>
	...
	public SchoolSession addSessionKeys(Long...objets) {
		for(Long o : objets) {
			addSessionKeys(o);
		}
		return (SchoolSession)this;
	}
	public SchoolSession addSessionKeys(Long o) {
		if(o != null && !sessionKeys.contains(o))
			this.sessionKeys.add(o);
		return (SchoolSession)this;
	}
	public SchoolSession setSessionKeys(JsonArray objets) {
		sessionKeys.clear();
		for(int i = 0; i < objets.size(); i++) {
			Long o = objets.getLong(i);
			addSessionKeys(o);
	...
	public SchoolSession addSessionKeys(String o) {
		if(org.apache.commons.lang3.math.NumberUtils.isCreatable(o)) {
			Long p = Long.parseLong(o);
			addSessionKeys(p);
		}
	...
	protected SchoolSession sessionKeysInit() {
	...
	public void htmSessionKeys(AllWriter r, Boolean patchRights) {
		if(pk!= null) {
			r.s("<div id=\"patchSchoolSession", strPk(), "SessionKeys\">");
			if(patchRights) {
				r.l();
				r.l("	<script>//<![CDATA[");
				r.l("		function patchSchoolSession", strPk(), "SessionKeys() {");
				r.l("			$.ajax({");
				r.l("				url: '?fq=pk:", strPk(), "',");
				r.l("				dataType: 'json',");
				r.l("				type: 'patch',");
	 ...
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.session.SchoolSession&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:seasonStart">Trouver l'entité seasonStart dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	...
	public void htmSeasonStart(AllWriter r, Boolean patchRights) {
		if(pk!= null) {
			r.s("<div id=\"patchSchoolSession", strPk(), "SeasonStart\">");
			if(patchRights) {
				r.l();
				r.l("	<script>//<![CDATA[");
				r.l("		function patchSchoolSession", strPk(), "SeasonStart() {");
				r.l("			$.ajax({");
				r.l("				url: '?fq=pk:", strPk(), "',");
				r.l("				dataType: 'json',");
				r.l("				type: 'patch',");
	...
	/**	L'entité « sessionSummer »
	 *	 is defined as null before being initialized. 
	 */
	protected Boolean sessionSummer;
	@JsonIgnore
	public Wrap<Boolean> sessionSummerWrap = new Wrap<Boolean>().p(this).c(Boolean.class).var("sessionSummer").o(sessionSummer);

	/**	<br/>L'entité « sessionSummer »
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.session.SchoolSession&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:sessionSummer">Trouver l'entité sessionSummer dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	protected abstract void _sessionSummer(Wrap<Boolean> c);

	public Boolean getSessionSummer() {
		return sessionSummer;
	}

	public void setSessionSummer(Boolean sessionSummer) {
		this.sessionSummer = sessionSummer;
		this.sessionSummerWrap.alreadyInitialized = true;
	}
	public SchoolSession setSessionSummer(String o) {
		this.sessionSummer = Boolean.parseBoolean(o);
		this.sessionSummerWrap.alreadyInitialized = true;
		return (SchoolSession)this;
	}
	protected SchoolSession sessionSummerInit() {
		if(!sessionSummerWrap.alreadyInitialized) {
			_sessionSummer(sessionSummerWrap);
			if(sessionSummer == null)
				setSessionSummer(sessionSummerWrap.o);
		}
		sessionSummerWrap.alreadyInitialized(true);
		return (SchoolSession)this;
	}

	public Boolean solrSessionSummer() {
		return sessionSummer;
	}

	public String strSessionSummer() {
		return sessionSummer == null ? "" : sessionSummer.toString();
	}

	public String nomAffichageSessionSummer() {
		return "summer";
	}

	public String htmTooltipSessionSummer() {
		return null;
	}

	public String htmSessionSummer() {
		return sessionSummer == null ? "" : StringEscapeUtils.escapeHtml4(strSessionSummer());
	}

	public void htmSessionSummer(AllWriter r, Boolean patchRights) {
		if(pk!= null) {
			r.s("<div id=\"patchSchoolSession", strPk(), "SessionSummer\">");
			if(patchRights) {
				r.l();
				r.l("	<script>//<![CDATA[");
				r.l("		function patchSchoolSession", strPk(), "SessionSummer() {");
				r.l("			$.ajax({");
				r.l("				url: '?fq=pk:", strPk(), "',");
				r.l("				dataType: 'json',");
				r.l("				type: 'patch',");
				...
				r.l("					");
				r.l("				},");
				r.l("				data: {\"setSessionSummer\": this.value },");
				r.l("				");
				r.l("			});");
				r.l("		}");
				r.l("	//]]></script>");
				r.l("	<div class=\"\">");
				r.l("		<label class=\"w3-tooltip \">");
				r.l("			<span>", StringEscapeUtils.escapeHtml4(nomAffichageSessionSummer()), "</span>");
				r.s("			<input");
							r.s(" name=\"sessionSummer\"");
							r.s(" value=\"", htmSessionSummer(), "\");");
							r.s(" onchange=\"\"");
							r.l("/>");
				r.l("		</label>");
				r.l("	</div>");
			} else {
				r.s(htmSessionSummer());
			}
			r.l("</div>");
		}
	}
	...
	/**	L'entité « sessionWinter »
	 *	 is defined as null before being initialized. 
	 */
	protected Boolean sessionWinter;
	@JsonIgnore
	public Wrap<Boolean> sessionWinterWrap = new Wrap<Boolean>().p(this).c(Boolean.class).var("sessionWinter").o(sessionWinter);

	/**	<br/>L'entité « sessionWinter »
	 *  est défini comme null avant d'être initialisé. 
	 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.scolaire.enUS.session.SchoolSession&fq=classeEtendGen_indexed_boolean:true&fq=entiteVar_enUS_indexed_string:sessionWinter">Trouver l'entité sessionWinter dans Solr</a>
	 * <br/>
	 * @param c est pour envelopper une valeur à assigner à cette entité lors de l'initialisation. 
	 **/
	protected abstract void _sessionWinter(Wrap<Boolean> c);

	public Boolean getSessionWinter() {
		return sessionWinter;
	}

	public void setSessionWinter(Boolean sessionWinter) {
		this.sessionWinter = sessionWinter;
		this.sessionWinterWrap.alreadyInitialized = true;
	}
	public SchoolSession setSessionWinter(String o) {
		this.sessionWinter = Boolean.parseBoolean(o);
		this.sessionWinterWrap.alreadyInitialized = true;
		return (SchoolSession)this;
	}
	protected SchoolSession sessionWinterInit() {
		if(!sessionWinterWrap.alreadyInitialized) {
			_sessionWinter(sessionWinterWrap);
			if(sessionWinter == null)
				setSessionWinter(sessionWinterWrap.o);
		}
		sessionWinterWrap.alreadyInitialized(true);
		return (SchoolSession)this;
	}

	public Boolean solrSessionWinter() {
		return sessionWinter;
	}

	public String strSessionWinter() {
		return sessionWinter == null ? "" : sessionWinter.toString();
	}

	public String nomAffichageSessionWinter() {
		return "winter";
	}

	public String htmTooltipSessionWinter() {
		return null;
	}

	public String htmSessionWinter() {
		return sessionWinter == null ? "" : StringEscapeUtils.escapeHtml4(strSessionWinter());
	}

	public void htmSessionWinter(AllWriter r, Boolean patchRights) {
		if(pk!= null) {
			r.s("<div id=\"patchSchoolSession", strPk(), "SessionWinter\">");
			if(patchRights) {
				r.l();
				r.l("	<script>//<![CDATA[");
				r.l("		function patchSchoolSession", strPk(), "SessionWinter() {");
				r.l("			$.ajax({");
				r.l("				url: '?fq=pk:", strPk(), "',");
				r.l("				dataType: 'json',");
				r.l("				type: 'patch',");
				...
				r.l("					");
				r.l("				},");
				r.l("				data: {\"setSessionWinter\": this.value },");
				r.l("				");
				r.l("			});");
				r.l("		}");
				r.l("	//]]></script>");
				r.l("	<div class=\"\">");
				r.l("		<label class=\"w3-tooltip \">");
				r.l("			<span>", StringEscapeUtils.escapeHtml4(nomAffichageSessionWinter()), "</span>");
				r.s("			<input");
							r.s(" name=\"sessionWinter\"");
							r.s(" value=\"", htmSessionWinter(), "\");");
							r.s(" onchange=\"\"");
							r.l("/>");
				r.l("		</label>");
				r.l("	</div>");
			} else {
				r.s(htmSessionWinter());
			}
			r.l("</div>");
		}
	}
	...
	public Object obtainSchoolSession(String var) {
		...
		switch(var) {
			...
			case "sessionKeys":
				return oSchoolSession.sessionKeys;
			case "educationSort":
			...
			case "seasonStart":
				return oSchoolSession.seasonStart;
			case "seasonSummer":
			...
			case "sessionWinter":
				return oSchoolSession.sessionWinter;
	...
	public Object defineSchoolSession(String var, String val) {
		switch(var) {
			...
			case "sessionEndDay":
				...
				return val;
			case "sessionSummer":
				setSessionSummer(val);
				savesSchoolSession.add(var);
				return val;
			case "sessionWinter":
				setSessionWinter(val);
				savesSchoolSession.add(var);
				return val;
			default:
	...
	public void populateSchoolSession(SolrDocument solrDocument) {
		...
		if(savesSchoolSession != null) {
			...
			if(savesSchoolSession.contains("sessionKeys")) {
				List<Long> sessionKeys = (List<Long>)solrDocument.get("sessionKeys_stored_longs");
				if(sessionKeys != null)
					oSchoolSession.sessionKeys.addAll(sessionKeys);
			}
			...
			if(savesSchoolSession.contains("seasonStart")) {
				Date seasonStart = (Date)solrDocument.get("seasonStart_stored_date");
				if(seasonStart != null)
					oSchoolSession.setSeasonStart(seasonStart);
			}
			...
			if(savesSchoolSession.contains("sessionWinter")) {
				Boolean sessionWinter = (Boolean)solrDocument.get("sessionWinter_stored_boolean");
				if(sessionWinter != null)
					oSchoolSession.setSessionWinter(sessionWinter);
			}
	...
	public void indexSchoolSession(SolrInputDocument document) {
		...
		if(sessionWinter != null) {
			document.addField("sessionWinter_indexed_boolean", sessionWinter);
			document.addField("sessionWinter_stored_boolean", sessionWinter);
		}
		if(sessionNameComplete != null) {
