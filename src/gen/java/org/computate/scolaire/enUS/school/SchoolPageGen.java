...
public abstract class SchoolPageGen<DEV> extends SchoolGenPage {
	...
	public void patchRequestSchoolPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		SchoolPage original = (SchoolPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestSchoolGenPage();
		}
	}
