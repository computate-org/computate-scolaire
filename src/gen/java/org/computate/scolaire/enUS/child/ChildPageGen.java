...
public abstract class ChildPageGen<DEV> extends ChildGenPage {
	...
	public void patchRequestChildPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		ChildPage original = (ChildPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestChildGenPage();
		}
	}
