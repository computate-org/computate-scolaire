...
public abstract class SchoolAgeGen<DEV> extends Cluster {
	...
	public void setEnrollmentKeys(String o) {
		Long l = SchoolAge.staticSetEnrollmentKeys(siteRequest_, o);
		if(l != null)
			addEnrollmentKeys(l);
		this.enrollmentKeysWrap.alreadyInitialized = true;
	}
	...
	public List<Long> solrEnrollmentKeys() {
		...
		for(Long o : enrollmentKeys) {
			l.add(SchoolAge.staticSolrEnrollmentKeys(siteRequest_, o));
		}
		return l;
	}
	...
	public void setBlockKeys(String o) {
		Long l = SchoolAge.staticSetBlockKeys(siteRequest_, o);
		if(l != null)
			addBlockKeys(l);
		this.blockKeysWrap.alreadyInitialized = true;
	}
	...
	public List<Long> solrBlockKeys() {
		...
		for(Long o : blockKeys) {
			l.add(SchoolAge.staticSolrBlockKeys(siteRequest_, o));
		}
		return l;
	}
	...
	public void inputBlockKeys(String classApiMethodMethod) {
		...
		if(
			...
			e("input")
				...
				.a("autocomplete", "off");
				a("oninput", "suggestSchoolAgeBlockKeys($(this).val() ? [ { 'name': 'q', 'value': 'objectSuggest:' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,pageUrlPk,blockCompleteName' } ] : [", pk == null ? "" : "{'name':'fq','value':'ageKey:" + pk + "'}", "], $('#listSchoolAgeBlockKeys_", classApiMethodMethod, "'), ", pk, "); ");
	...
	public void inputYearKey(String classApiMethodMethod) {
		...
		if(
			...
			e("input")
				...
				.a("autocomplete", "off");
				a("oninput", "suggestSchoolAgeYearKey($(this).val() ? [ { 'name': 'q', 'value': 'objectSuggest:' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,pageUrlPk,yearCompleteName' } ] : [", pk == null ? "" : "{'name':'fq','value':'ageKeys:" + pk + "'}", "], $('#listSchoolAgeYearKey_", classApiMethodMethod, "'), ", pk, "); ");
	...
	public String sqlYearShortName() {
		return yearShortName;
	}
	...
	public String sqlYearCompleteName() {
		return yearCompleteName;
	}
	...
	public static Object staticSolrSchoolAge(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		...
		case "enrollmentKeys":
			return SchoolAge.staticSolrEnrollmentKeys(siteRequest_, (Long)o);
		case "blockKeys":
			return SchoolAge.staticSolrBlockKeys(siteRequest_, (Long)o);
		case "educationSort":
	...
	public static String staticSolrStrSchoolAge(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		...
		case "enrollmentKeys":
			return SchoolAge.staticSolrStrEnrollmentKeys(siteRequest_, (Long)o);
		case "blockKeys":
			return SchoolAge.staticSolrStrBlockKeys(siteRequest_, (Long)o);
		case "educationSort":
	...
	public Object defineSchoolAge(String var, Object val) {
		switch(var.toLowerCase()) {
			case "sessionkey":
				if(val instanceof Long)
					setSessionKey((Long)val);
				saves.add("sessionKey");
				return val;
			case "yearkey":
				if(val instanceof Long)
			...
			case "agestart":
				if(val instanceof Integer)
					setAgeStart((Integer)val);
				saves.add("ageStart");
				return val;
			case "ageend":
				if(val instanceof Integer)
					setAgeEnd((Integer)val);
				saves.add("ageEnd");
				return val;
			default:
				return super.defineCluster(var, val);
