...
public abstract class MomPageGen<DEV> extends MomGenPage {
	...
	public void patchRequestMomPage() {
		PatchRequest patchRequest = Optional.ofNullable(siteRequest_).map(SiteRequestEnUS::getPatchRequest_).orElse(null);
		MomPage original = (MomPage)Optional.ofNullable(patchRequest).map(PatchRequest::getOriginal).orElse(null);
		if(original != null) {
			super.patchRequestMomGenPage();
		}
	}
