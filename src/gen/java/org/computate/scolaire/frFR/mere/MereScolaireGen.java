...
public abstract class MereScolaireGen<DEV> extends Cluster {
	...
	public void inputInscriptionCles(String classeApiMethodeMethode) {
		...
		if(
			...
			e("input")
				...
				.a("autocomplete", "off");
				a("oninput", "suggereMereScolaireInscriptionCles($(this).val() ? [ { 'name': 'q', 'value': 'objetSuggere:' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,pageUrlPk,inscriptionNomComplet' } ] : [", pk == null ? "" : "{'name':'fq','value':'mereCles:" + pk + "'}", "], $('#listMereScolaireInscriptionCles_", classeApiMethodeMethode, "'), ", pk, "); ");
	...
	public String sqlMereNomComplet() {
		return mereNomComplet;
	}
	...
	public Object definirMereScolaire(String var, Object val) {
		switch(var.toLowerCase()) {
			case "personneprenom":
