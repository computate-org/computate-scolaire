...
/**	
 * <br/><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.scolaire.frFR.mere.MerePage&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr. </a>
 * <br/>
 **/
public abstract class MerePageGen<DEV> extends MereGenPage {
	protected static final Logger LOGGER = LoggerFactory.getLogger(MerePage.class);
	...
	public Object definirMerePage(String var, Object val) {
		switch(var.toLowerCase()) {
			default:
				return super.definirMereGenPage(var, val);
		}
