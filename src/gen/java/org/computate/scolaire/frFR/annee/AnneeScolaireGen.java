...
public abstract class AnneeScolaireGen<DEV> extends Cluster {
	...
	public void inputEcoleCle(String classeApiMethodeMethode) {
		...
		if(
			...
			e("input")
				...
				.a("autocomplete", "off");
				a("oninput", "suggereAnneeScolaireEcoleCle($(this).val() ? [ { 'name': 'q', 'value': 'objetSuggere:' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,pageUrlPk,ecoleNomComplet' } ] : [", pk == null ? "" : "{'name':'fq','value':'anneeCles:" + pk + "'}", "], $('#listAnneeScolaireEcoleCle_", classeApiMethodeMethode, "'), ", pk, "); ");
	...
	public void setInscriptionCles(String o) {
		Long l = AnneeScolaire.staticSetInscriptionCles(requeteSite_, o);
		if(l != null)
	...
	public List<Long> solrInscriptionCles() {
		...
		for(Long o : inscriptionCles) {
			l.add(AnneeScolaire.staticSolrInscriptionCles(requeteSite_, o));
		}
		return l;
	}
	...
	public void setSaisonCles(String o) {
		Long l = AnneeScolaire.staticSetSaisonCles(requeteSite_, o);
		if(l != null)
			addSaisonCles(l);
		this.saisonClesCouverture.dejaInitialise = true;
	}
	...
	public List<Long> solrSaisonCles() {
		...
		for(Long o : saisonCles) {
			l.add(AnneeScolaire.staticSolrSaisonCles(requeteSite_, o));
		}
		return l;
	}
	...
	public void setAgeCles(String o) {
		Long l = AnneeScolaire.staticSetAgeCles(requeteSite_, o);
		if(l != null)
			addAgeCles(l);
		this.ageClesCouverture.dejaInitialise = true;
	}
	...
	public List<Long> solrAgeCles() {
		List<Long> l = new ArrayList<Long>();
		for(Long o : ageCles) {
			l.add(AnneeScolaire.staticSolrAgeCles(requeteSite_, o));
		}
		return l;
	}
	...
	public void inputAgeCles(String classeApiMethodeMethode) {
		...
		if(
			...
			e("input")
				...
				.a("autocomplete", "off");
				a("oninput", "suggereAnneeScolaireAgeCles($(this).val() ? [ { 'name': 'q', 'value': 'objetSuggere:' + $(this).val() }, { 'name': 'rows', 'value': '10' }, { 'name': 'fl', 'value': 'pk,pageUrlPk,ageNomComplet' } ] : [", pk == null ? "" : "{'name':'fq','value':'anneeCle:" + pk + "'}", "], $('#listAnneeScolaireAgeCles_", classeApiMethodeMethode, "'), ", pk, "); ");
	...
	public String sqlAnneeNomCourt() {
		return anneeNomCourt;
	}
	...
	public String sqlAnneeNomComplet() {
		return anneeNomComplet;
	}
	...
	public static Object staticSolrAnneeScolaire(String entiteVar, RequeteSiteFrFR requeteSite_, Object o) {
		...
		case "inscriptionCles":
			return AnneeScolaire.staticSolrInscriptionCles(requeteSite_, (Long)o);
		case "saisonCles":
			return AnneeScolaire.staticSolrSaisonCles(requeteSite_, (Long)o);
		case "ageCles":
			return AnneeScolaire.staticSolrAgeCles(requeteSite_, (Long)o);
		case "scolaireTri":
	...
	public static String staticSolrStrAnneeScolaire(String entiteVar, RequeteSiteFrFR requeteSite_, Object o) {
		...
		case "inscriptionCles":
			return AnneeScolaire.staticSolrStrInscriptionCles(requeteSite_, (Long)o);
		case "saisonCles":
			return AnneeScolaire.staticSolrStrSaisonCles(requeteSite_, (Long)o);
		case "ageCles":
			return AnneeScolaire.staticSolrStrAgeCles(requeteSite_, (Long)o);
		case "scolaireTri":
	...
	public Object definirAnneeScolaire(String var, String val) {
		switch(var.toLowerCase()) {
			...
			case "sessiondatedebut":
				...
				sauvegardes.add("sessionDateDebut");
				return val;
			case "saisondatedebut":
				if(val != null)
					setSaisonDateDebut(val);
				sauvegardes.add("saisonDateDebut");
				return val;
			case "sessiondatefin":
				if(val != null)
					setSessionDateFin(val);
				sauvegardes.add("sessionDateFin");
				return val;
			case "anneedebut":
				if(val != null)
					setAnneeDebut(val);
				sauvegardes.add("anneeDebut");
				return val;
			case "anneefin":
				if(val != null)
					setAnneeFin(val);
				sauvegardes.add("anneeFin");
				return val;
			case "anneefraisinscription":
				if(val != null)
					setAnneeFraisInscription(val);
				sauvegardes.add("anneeFraisInscription");
				return val;
			default:
	...
	public Object definirAnneeScolaire(String var, Object val) {
		switch(var.toLowerCase()) {
			case "ecolecle":
			...
			case "sessiondatedebut":
				if(val instanceof LocalDate)
					setSessionDateDebut((LocalDate)val);
				sauvegardes.add("sessionDateDebut");
				return val;
			case "saisondatedebut":
				if(val instanceof LocalDate)
					setSaisonDateDebut((LocalDate)val);
				sauvegardes.add("saisonDateDebut");
				return val;
			case "sessiondatefin":
				if(val instanceof LocalDate)
					setSessionDateFin((LocalDate)val);
				sauvegardes.add("sessionDateFin");
				return val;
			case "anneedebut":
				if(val instanceof Integer)
					setAnneeDebut((Integer)val);
				sauvegardes.add("anneeDebut");
				return val;
			case "anneefin":
				if(val instanceof Integer)
					setAnneeFin((Integer)val);
				sauvegardes.add("anneeFin");
				return val;
			case "anneefraisinscription":
				if(val instanceof BigDecimal)
					setAnneeFraisInscription((BigDecimal)val);
				sauvegardes.add("anneeFraisInscription");
				return val;
			default:
				return super.definirCluster(var, val);
