...
public abstract class AnneePageGen<DEV> extends AnneeGenPage {
	...
	public void requetePatchAnneePage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		AnneePage original = (AnneePage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
			super.requetePatchAnneeGenPage();
		}
	}
