...
public abstract class InscriptionFormGenPageGen<DEV> extends ClusterPage {
	protected static final Logger LOGGER = LoggerFactory.getLogger(InscriptionFormGenPage.class);
	...
	public void requeteApiInscriptionFormGenPage() {
		...
		if(o != null && o instanceof InscriptionFormGenPage) {
			InscriptionFormGenPage original = (InscriptionFormGenPage)o;
