...
public abstract class InscriptionFormGenPageGen<DEV> extends ClusterPage {
	...
	public void requetePatchInscriptionFormGenPage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		InscriptionFormGenPage original = (InscriptionFormGenPage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
