...
public abstract class InscriptionMailGenPageGen<DEV> extends ClusterPage {
	protected static final Logger LOGGER = LoggerFactory.getLogger(InscriptionMailGenPage.class);
	...
	public void requeteApiInscriptionMailGenPage() {
		...
		if(o != null && o instanceof InscriptionMailGenPage) {
			InscriptionMailGenPage original = (InscriptionMailGenPage)o;
