...
public abstract class InscriptionMailGenPageGen<DEV> extends ClusterPage {
	...
	public void requetePatchInscriptionMailGenPage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		InscriptionMailGenPage original = (InscriptionMailGenPage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
