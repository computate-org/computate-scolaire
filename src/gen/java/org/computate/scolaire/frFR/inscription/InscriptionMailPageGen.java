...
public abstract class InscriptionMailPageGen<DEV> extends InscriptionMailGenPage {
	...
	public void requetePatchInscriptionMailPage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		InscriptionMailPage original = (InscriptionMailPage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
			super.requetePatchInscriptionMailGenPage();
		}
	}
