...
public abstract class InscriptionFormPageGen<DEV> extends InscriptionFormGenPage {
	...
	public void requetePatchInscriptionFormPage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		InscriptionFormPage original = (InscriptionFormPage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
			super.requetePatchInscriptionFormGenPage();
		}
	}
