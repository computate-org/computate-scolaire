...
public abstract class GardienGenPageGen<DEV> extends ClusterPage {
	...
	public void requetePatchGardienGenPage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		GardienGenPage original = (GardienGenPage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
