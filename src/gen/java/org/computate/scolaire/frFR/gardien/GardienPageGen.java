...
public abstract class GardienPageGen<DEV> extends GardienGenPage {
	...
	public void requetePatchGardienPage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		GardienPage original = (GardienPage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
			super.requetePatchGardienGenPage();
		}
	}
