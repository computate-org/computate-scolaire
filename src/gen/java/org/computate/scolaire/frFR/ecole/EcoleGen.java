...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_frFR_indexed_string:org.computate.scolaire.frFR.ecole.Ecole&fq=classeEtendGen_indexed_boolean:true">Trouver la classe objectSuggest dans Solr</a>
 * <br/>
 **/
public abstract class EcoleGen<DEV> extends Cluster {
	...
	public void htmPageUri(ToutEcrivain r, Boolean patchDroits) {
		if(pk!= null) {
			r.s("<div id=\"patchEcole", strPk(), "PageUri\">");
			if(patchDroits) {
				r.l();
				r.l("	<script>//<![CDATA[");
	...
	public void peuplerEcole(SolrDocument solrDocument) {
		...
		if(sauvegardesEcole != null) {
			...
			if(sauvegardesEcole.contains("pageUri")) {
