...
public abstract class AgePageGen<DEV> extends AgeGenPage {
	...
	public void requetePatchAgePage() {
		RequetePatch requetePatch = Optional.ofNullable(requeteSite_).map(RequeteSiteFrFR::getRequetePatch_).orElse(null);
		AgePage original = (AgePage)Optional.ofNullable(requetePatch).map(RequetePatch::getOriginal).orElse(null);
		if(original != null) {
			super.requetePatchAgeGenPage();
		}
	}
