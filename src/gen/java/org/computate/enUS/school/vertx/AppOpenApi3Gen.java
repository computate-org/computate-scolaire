...
/**	
 * <br/><a href="http://localhost:10383/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.enUS.school.vertx.AppOpenApi3&fq=classeEtendGen_indexed_boolean:true">Trouver la classe  dans Solr</a>
 * <br/>
 **/
public abstract class AppOpenApi3Gen<DEV> extends AppliSwagger2 {
	...
	public void initDeepAppOpenApi3() {
		super.initDeepAppliSwagger2(siteRequest_);
		initAppOpenApi3();
	}
	...
	public void siteRequestAppOpenApi3(SiteRequestEnUS siteRequest_) {
			super.siteRequestAppliSwagger2(siteRequest_);
	}
	...
	public Object obtainAppOpenApi3(String var) {
		...
		switch(var) {
			default:
				return super.obtainAppliSwagger2(var);
		}
	}
	...
	public Object attributeAppOpenApi3(String var, Object val) {
		...
		switch(var) {
			default:
				return super.attributeAppliSwagger2(var, val);
		}
	}
	...
	public Object defineAppOpenApi3(String var, String val) {
		switch(var) {
			default:
				return super.defineAppliSwagger2(var, val);
		}
	}
