...
computate "xdg-open 'http://localhost:10383/solr/computate/select?q=*:*&sort=modifiee_indexed_date%20desc&fq=classeNomSimple_enUS_indexed_string:BankAdjustment';\
...
computate "xdg-open 'http://localhost:10383/solr/computate/select?q=*:*&sort=modifiee_indexed_date%20desc&json.facet={}&rows=0';\
...
#computate "xdg-open 'http://localhost:10383/solr/computate/select?q=*:*&sort=modifiee_indexed_date%20desc&json.facet={partIsClass:'"'"'"'"'"'"'sum(partEstClasse_indexed_boolean)'"'"'"'"'"'"'}&rows=0';\
#echo '500 of them are Java classes. '"

#computate "xdg-open 'http://localhost:10383/solr/computate/select?q=*:*&sort=modifiee_indexed_date%20desc&json.facet={partIsClass:'"'"'"'"'"'"'sum(partEstClasse_indexed_boolean)'"'"'"'"'"'"',partIsMethod:'"'"'"'"'"'"'sum(partEstMethode_indexed_boolean)'"'"'"'"'"'"'}&rows=0';\
#echo 'Over 5,000 of them are Java methods. '"

#computate "xdg-open 'http://localhost:10383/solr/computate/select?q=*:*&sort=modifiee_indexed_date%20desc&json.facet={partIsClass:'"'"'"'"'"'"'sum(partEstClasse_indexed_boolean)'"'"'"'"'"'"',partIsMethod:'"'"'"'"'"'"'sum(partEstMethode_indexed_boolean)'"'"'"'"'"'"',partIsField:'"'"'"'"'"'"'sum(partEstChamp_indexed_boolean)'"'"'"'"'"'"'}&rows=0';\
#echo 'Over 800 of them are Java fields. '"

#computate "xdg-open 'http://localhost:10383/solr/computate/select?q=*:*&sort=modifiee_indexed_date%20desc&json.facet={partIsClass:'"'"'"'"'"'"'sum(partEstClasse_indexed_boolean)'"'"'"'"'"'"',partIsMethod:'"'"'"'"'"'"'sum(partEstMethode_indexed_boolean)'"'"'"'"'"'"',partIsField:'"'"'"'"'"'"'sum(partEstChamp_indexed_boolean)'"'"'"'"'"'"',partIsEntity:'"'"'"'"'"'"'sum(partEstEntite_indexed_boolean)'"'"'"'"'"'"'}&rows=0';\
